...
func TestCampaignSpendNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Marketing.Campaigns.Spend.New(
		context.TODO(),
		"campaignGuid",
...
func TestCampaignSpendUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Marketing.Campaigns.Spend.Update(
		context.TODO(),
		0,
...
func TestCampaignSpendDelete(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestCampaignSpendGet(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Marketing.Campaigns.Spend.Get(
		context.TODO(),
		0,
