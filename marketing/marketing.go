...
type EmailSendStatusView struct {
	...
	// "CANCELLED_ABUSE", "CONTACT_VIEW_PERMISSION", "CORRUPT_INPUT", "EMAIL_DISABLED",
	// "EMAIL_UNCONFIRMED", "GDPR_DOI_ENABLED", "GRAYMAIL_SUPPRESSED",
	// "HUBL_LIMIT_EXCEEDED", "IDEMPOTENT_FAIL", "IDEMPOTENT_IGNORE",
	// "INVALID_APP_ID_ATTRIBUTION", "INVALID_FROM_ADDRESS", "INVALID_TO_ADDRESS",
	// "LOW_CONTACT_QUALITY_SCORE", "MISSING_CONTENT", "MISSING_REQUIRED_PARAMETER",
	// "MISSING_TEMPLATE_PROPERTIES", "MTA_IGNORE", "NON_MARKETABLE_CONTACT",
	// "PORTAL_AUTHENTICATION_FAILURE", "PORTAL_EXPIRED",
...
const (
	...
	EmailSendStatusViewSendResultContactViewPermission              EmailSendStatusViewSendResult = "CONTACT_VIEW_PERMISSION"
