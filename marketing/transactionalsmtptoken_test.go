...
func TestTransactionalSmtpTokenNew(t *testing.T) {
...
func TestTransactionalSmtpTokenListWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Marketing.Transactional.SmtpTokens.List(context.TODO(), marketing.TransactionalSmtpTokenListParams{
		...
		CampaignName:    hubspotsdk.String("campaignName"),
		EmailCampaignID: hubspotsdk.String("emailCampaignId"),
...
func TestTransactionalSmtpTokenDelete(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestTransactionalSmtpTokenGet(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestTransactionalSmtpTokenResetPassword(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
