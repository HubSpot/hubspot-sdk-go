...
type EmailService struct {
	...
	Statistics EmailStatisticService
}
...
func NewEmailService(opts ...option.RequestOption) (r EmailService) {
	r = EmailService{}
	r.Options = opts
	r.Statistics = NewEmailStatisticService(opts...)
	return
}
...
func (r *EmailService) Update(ctx context.Context, emailID string, params EmailUpdateParams, opts ...option.RequestOption) (res *PublicEmail, err error) {
	...
	path := fmt.Sprintf("marketing/v3/emails/%s", emailID)
...
func (r *EmailService) Get(ctx context.Context, emailID string, query EmailGetParams, opts ...option.RequestOption) (res *PublicEmail, err error) {
	opts = slices.Concat(r.Options, opts)
	if emailID == "" {
		err = errors.New("missing required emailId parameter")
		return
...
func (r *EmailService) GetDraft(ctx context.Context, emailID string, opts ...option.RequestOption) (res *PublicEmail, err error) {
	...
	path := fmt.Sprintf("marketing/v3/emails/%s/draft", emailID)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return
}

// Get a specific revision of a marketing email.
func (r *EmailService) GetRevision(ctx context.Context, revisionID string, query EmailGetRevisionParams, opts ...option.RequestOption) (res *VersionPublicEmail, err error) {
	opts = slices.Concat(r.Options, opts)
	if query.EmailID == "" {
		err = errors.New("missing required emailId parameter")
		return
	...
	path := fmt.Sprintf("marketing/v3/emails/%s/revisions/%s", query.EmailID, revisionID)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return
}
...
func (r *EmailService) Publish(ctx context.Context, emailID string, opts ...option.RequestOption) (err error) {
	...
	path := fmt.Sprintf("marketing/v3/emails/%s/publish", emailID)
...
func (r *EmailService) ResetDraft(ctx context.Context, emailID string, opts ...option.RequestOption) (err error) {
	...
	path := fmt.Sprintf("marketing/v3/emails/%s/draft/reset", emailID)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPost, path, nil, nil, opts...)
	return
}
...
func (r *EmailService) RestoreRevision(ctx context.Context, revisionID string, body EmailRestoreRevisionParams, opts ...option.RequestOption) (err error) {
	...
	path := fmt.Sprintf("marketing/v3/emails/%s/revisions/%s/restore", body.EmailID, revisionID)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPost, path, nil, nil, opts...)
	return
}
...
func (r *EmailService) RestoreRevisionToDraft(ctx context.Context, revisionID int64, body EmailRestoreRevisionToDraftParams, opts ...option.RequestOption) (res *PublicEmail, err error) {
	...
	path := fmt.Sprintf("marketing/v3/emails/%s/revisions/%v/restore-to-draft", body.EmailID, revisionID)
...
func (r *EmailService) Unpublish(ctx context.Context, emailID string, opts ...option.RequestOption) (err error) {
	...
	path := fmt.Sprintf("marketing/v3/emails/%s/unpublish", emailID)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPost, path, nil, nil, opts...)
	return
}
...
type AggregateEmailStatistics struct {
	Aggregate EmailStatisticsData `json:"aggregate"`
	// The aggregated statistics per campaign.
	CampaignAggregations map[string]EmailStatisticsData `json:"campaignAggregations"`
...
type CollectionResponseWithTotalEmailStatisticIntervalNoPaging struct {
	...
	Results []EmailStatisticInterval `json:"results,required"`
...
// Returns the unmodified JSON received from the API
func (r CollectionResponseWithTotalEmailStatisticIntervalNoPaging) RawJSON() string {
	return r.JSON.raw
}
func (r *CollectionResponseWithTotalEmailStatisticIntervalNoPaging) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type CollectionResponseWithTotalPublicEmailForwardPaging struct {
	...
	Results []PublicEmail `json:"results,required"`
...
// Returns the unmodified JSON received from the API
func (r CollectionResponseWithTotalPublicEmailForwardPaging) RawJSON() string { return r.JSON.raw }
func (r *CollectionResponseWithTotalPublicEmailForwardPaging) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Returns the unmodified JSON received from the API
func (r CollectionResponseWithTotalVersionPublicEmail) RawJSON() string { return r.JSON.raw }
func (r *CollectionResponseWithTotalVersionPublicEmail) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type EmailCreateRequestParam struct {
	...
	// "en-150", "en-ae", "en-ag", "en-ai", "en-as", "en-at", "en-au", "en-bb",
	// "en-be", "en-bi", "en-bm", "en-bs", "en-bw", "en-bz", "en-ca", "en-cc", "en-ch",
	// "en-ck", "en-cm", "en-cn", "en-cx", "en-cy", "en-de", "en-dg", "en-dk", "en-dm",
	// "en-ee", "en-eg", "en-er", "en-es", "en-fi", "en-fj", "en-fk", "en-fm", "en-fr",
...
type EmailStatisticsData struct {
	...
	DeviceBreakdown map[string]map[string]int64 `json:"deviceBreakdown,required"`
	// Number of emails that were dropped and bounced.
	QualifierStats map[string]map[string]int64 `json:"qualifierStats,required"`
	// Ratios like `openratio` or `clickratio`
	Ratios map[string]float64 `json:"ratios,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type PublicEmailStyleSettings struct {
	...
	BackgroundImageType     string                     `json:"backgroundImageType"`
...
type PublicEmailStyleSettingsParam struct {
	...
	BackgroundImageType     param.Opt[string]               `json:"backgroundImageType,omitzero"`
...
type PublicEmailTestingDetails struct {
	...
	IsAbVariation bool  `json:"isAbVariation"`
...
type PublicEmailTestingDetailsParam struct {
	...
	IsAbVariation param.Opt[bool]  `json:"isAbVariation,omitzero"`
	// The ID of the AB test.
...
type PublicRssEmailDetails struct {
	...
	BlogLayout           string         `json:"blogLayout"`
...
type PublicRssEmailDetailsParam struct {
	...
	BlogLayout           param.Opt[string] `json:"blogLayout,omitzero"`
...
type VersionPublicEmail struct {
	...
	ID string `json:"id,required"`
	// A marketing email
	Object    PublicEmail `json:"object,required"`
...
func (r *EmailNewParams) UnmarshalJSON(data []byte) error {
	return json.Unmarshal(data, &r.EmailCreateRequest)
}
...
func (r *EmailUpdateParams) UnmarshalJSON(data []byte) error {
	return json.Unmarshal(data, &r.EmailUpdateRequest)
}
...
func (r *EmailCloneParams) UnmarshalJSON(data []byte) error {
	return json.Unmarshal(data, &r.EmailCloneRequestVNext)
}
...
type EmailGetRevisionParams struct {
	EmailID string `path:"emailId,required" json:"-"`
	paramObj
}
