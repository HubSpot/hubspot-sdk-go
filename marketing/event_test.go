	...
	_, err := client.Marketing.Events.New(context.TODO(), marketing.EventNewParams{
		MarketingEventCreateRequestParams: marketing.MarketingEventCreateRequestParams{
			...
			CustomProperties: []marketing.PropertyValueParam{{
				...
				Value:                              "",
				DataSensitivity:                    marketing.PropertyValueDataSensitivityNone,
				IsEncrypted:                        hubspotsdk.Bool(false),
				IsLargeValue:                       hubspotsdk.Bool(true),
				PersistenceTimestamp:               hubspotsdk.Int(0),
				RequestID:                          hubspotsdk.String(""),
				SelectedByUser:                     hubspotsdk.Bool(false),
				SelectedByUserTimestamp:            hubspotsdk.Int(0),
				Source:                             marketing.PropertyValueSourceUnknown,
				SourceID:                           hubspotsdk.String(""),
				SourceLabel:                        hubspotsdk.String(""),
				SourceMetadata:                     hubspotsdk.String(""),
				SourceVid:                          []int64{0},
				Timestamp:                          hubspotsdk.Int(0),
				Unit:                               hubspotsdk.String(""),
				UpdatedByUserID:                    hubspotsdk.Int(0),
				UseTimestampAsPersistenceTimestamp: hubspotsdk.Bool(true),
			}},
