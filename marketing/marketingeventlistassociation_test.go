...
func TestMarketingEventListAssociationList(t *testing.T) {
	...
	_, err := client.Marketing.MarketingEvents.ListAssociations.List(context.TODO(), "marketingEventId")
	if err != nil {
...
func TestMarketingEventListAssociationDelete(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestMarketingEventListAssociationAssociate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestMarketingEventListAssociationAssociateByExternalAccount(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestMarketingEventListAssociationDeleteByExternalAccount(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestMarketingEventListAssociationListByExternalAccount(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Marketing.MarketingEvents.ListAssociations.ListByExternalAccount(
		context.TODO(),
		"externalEventId",
