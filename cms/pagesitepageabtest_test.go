...
func TestPageSitePageAbTestNewSitePageVariation(t *testing.T) {
	...
	_, err := client.Cms.Pages.SitePages.AbTest.NewSitePageVariation(context.TODO(), cms.PageSitePageAbTestNewSitePageVariationParams{
...
func TestPageSitePageAbTestEndSitePageTest(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestPageSitePageAbTestRerunSitePageTest(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
