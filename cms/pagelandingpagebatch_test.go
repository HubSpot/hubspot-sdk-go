...
func TestPageLandingPageBatchNewLandingPages(t *testing.T) {
	...
	_, err := client.Cms.Pages.LandingPages.Batch.NewLandingPages(context.TODO(), cms.PageLandingPageBatchNewLandingPagesParams{
...
func TestPageLandingPageBatchDeleteLandingPages(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestPageLandingPageBatchGetLandingPagesWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Cms.Pages.LandingPages.Batch.GetLandingPages(context.TODO(), cms.PageLandingPageBatchGetLandingPagesParams{
		BatchInputString: shared.BatchInputStringParam{
			Inputs: []string{"string"},
		},
...
func TestPageLandingPageBatchUpdateLandingPagesWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Cms.Pages.LandingPages.Batch.UpdateLandingPages(context.TODO(), cms.PageLandingPageBatchUpdateLandingPagesParams{
