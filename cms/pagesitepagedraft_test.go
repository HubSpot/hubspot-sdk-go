...
func TestPageSitePageDraftGetDraft(t *testing.T) {
	...
	_, err := client.Cms.Pages.SitePages.Draft.GetDraft(context.TODO(), "objectId")
	if err != nil {
...
func TestPageSitePageDraftPublishDraft(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestPageSitePageDraftResetSitePageDraft(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestPageSitePageDraftUpdateDraft(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Cms.Pages.SitePages.Draft.UpdateDraft(
		context.TODO(),
		"objectId",
