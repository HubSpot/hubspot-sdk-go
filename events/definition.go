...
func (r *DefinitionService) New(ctx context.Context, body DefinitionNewParams, opts ...option.RequestOption) (res *ExternalBehavioralEventTypeDefinition, err error) {
...
func (r *DefinitionService) Update(ctx context.Context, eventName string, body DefinitionUpdateParams, opts ...option.RequestOption) (res *ExternalBehavioralEventTypeDefinition, err error) {
	opts = slices.Concat(r.options, opts)
	if eventName == "" {
		err = errors.New("missing required eventName parameter")
		return nil, err
	}
	path := fmt.Sprintf("events/2026-03/event-definitions/%s", url.PathEscape(eventName))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPatch, path, body, &res, opts...)
	return res, err
}

// Retrieve existing custom event definitions.
func (r *DefinitionService) List(ctx context.Context, query DefinitionListParams, opts ...option.RequestOption) (res *pagination.Page[ExternalBehavioralEventTypeDefinition], err error) {
...
// Retrieve existing custom event definitions.
func (r *DefinitionService) ListAutoPaging(ctx context.Context, query DefinitionListParams, opts ...option.RequestOption) *pagination.PageAutoPager[ExternalBehavioralEventTypeDefinition] {
	return pagination.NewPageAutoPager(r.List(ctx, query, opts...))
}

// Delete a custom event definition by name.
func (r *DefinitionService) Delete(ctx context.Context, eventName string, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.options, opts)
...
func (r *DefinitionService) NewProperty(ctx context.Context, eventName string, body DefinitionNewPropertyParams, opts ...option.RequestOption) (res *shared.Property, err error) {
	...
	path := fmt.Sprintf("events/2026-03/event-definitions/%s/property", url.PathEscape(eventName))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPost, path, body, &res, opts...)
	return res, err
}

// Delete an existing property from a custom event definition.
func (r *DefinitionService) DeleteProperty(ctx context.Context, propertyName string, body DefinitionDeletePropertyParams, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.options, opts)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "*/*")}, opts...)
	if body.EventName == "" {
		err = errors.New("missing required eventName parameter")
	...
	path := fmt.Sprintf("events/2026-03/event-definitions/%s/property/%s", url.PathEscape(body.EventName), url.PathEscape(propertyName))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodDelete, path, nil, nil, opts...)
	return err
}

// Fetch a single custom event definition by name.
func (r *DefinitionService) Get(ctx context.Context, eventName string, opts ...option.RequestOption) (res *ExternalBehavioralEventTypeDefinition, err error) {
	opts = slices.Concat(r.options, opts)
	if eventName == "" {
		err = errors.New("missing required eventName parameter")
		return nil, err
...
func (r *DefinitionService) SendBatch(ctx context.Context, body DefinitionSendBatchParams, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.options, opts)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "*/*")}, opts...)
...
func (r *DefinitionService) UpdateProperty(ctx context.Context, propertyName string, params DefinitionUpdatePropertyParams, opts ...option.RequestOption) (res *shared.Property, err error) {
	...
	path := fmt.Sprintf("events/2026-03/event-definitions/%s/property/%s", url.PathEscape(params.EventName), url.PathEscape(propertyName))
...
type DefinitionsAssociationDefinition struct {
	...
	Cardinality DefinitionsAssociationDefinitionCardinality `json:"cardinality" api:"required"`
	// The error category
	//
	// Any of "HUBSPOT_DEFINED", "INTEGRATOR_DEFINED", "USER_DEFINED", "WORK".
	Category DefinitionsAssociationDefinitionCategory `json:"category" api:"required"`
	...
	//
	// Any of "ONE_TO_MANY", "ONE_TO_ONE".
	InverseCardinality DefinitionsAssociationDefinitionInverseCardinality `json:"inverseCardinality" api:"required"`
	...
	FromObjectType DefinitionsAssociationDefinitionFromObjectType `json:"fromObjectType"`
	// Any of "DEFAULT", "INTERNAL", "USER_CONFIGURED".
	HiddenReason DefinitionsAssociationDefinitionHiddenReason `json:"hiddenReason"`
	...
	// "SUBSCRIPTION", "TASK", "TASK_TEMPLATE", "TAX", "TEMPLATE", "TICKET", "UNKNOWN",
	// "UNSUBSCRIBE", "USER", "VIEW", "VIEW_BLOCK", "WEB_INTERACTIVE".
	ToObjectType DefinitionsAssociationDefinitionToObjectType `json:"toObjectType"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		ID                              respjson.Field
...
// Returns the unmodified JSON received from the API
func (r DefinitionsAssociationDefinition) RawJSON() string { return r.JSON.raw }
func (r *DefinitionsAssociationDefinition) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The cardinality from the source object's perspective, either "ONE_TO_ONE" or
// "ONE_TO_MANY".
type DefinitionsAssociationDefinitionCardinality string

const (
	DefinitionsAssociationDefinitionCardinalityOneToMany DefinitionsAssociationDefinitionCardinality = "ONE_TO_MANY"
	DefinitionsAssociationDefinitionCardinalityOneToOne  DefinitionsAssociationDefinitionCardinality = "ONE_TO_ONE"
)

// The error category
type DefinitionsAssociationDefinitionCategory string

const (
	DefinitionsAssociationDefinitionCategoryHubSpotDefined    DefinitionsAssociationDefinitionCategory = "HUBSPOT_DEFINED"
	DefinitionsAssociationDefinitionCategoryIntegratorDefined DefinitionsAssociationDefinitionCategory = "INTEGRATOR_DEFINED"
	DefinitionsAssociationDefinitionCategoryUserDefined       DefinitionsAssociationDefinitionCategory = "USER_DEFINED"
	DefinitionsAssociationDefinitionCategoryWork              DefinitionsAssociationDefinitionCategory = "WORK"
)

// The cardinality from the destination object's perspective, either "ONE_TO_ONE"
// or "ONE_TO_MANY".
type DefinitionsAssociationDefinitionInverseCardinality string

const (
	DefinitionsAssociationDefinitionInverseCardinalityOneToMany DefinitionsAssociationDefinitionInverseCardinality = "ONE_TO_MANY"
	DefinitionsAssociationDefinitionInverseCardinalityOneToOne  DefinitionsAssociationDefinitionInverseCardinality = "ONE_TO_ONE"
)

// The name of the source object type (e.g,. "DEAL" or "QUOTE").
type DefinitionsAssociationDefinitionFromObjectType string

const (
	DefinitionsAssociationDefinitionFromObjectTypeAbandonedCart                     DefinitionsAssociationDefinitionFromObjectType = "ABANDONED_CART"
	DefinitionsAssociationDefinitionFromObjectTypeAcceptanceTest                    DefinitionsAssociationDefinitionFromObjectType = "ACCEPTANCE_TEST"
	DefinitionsAssociationDefinitionFromObjectTypeAd                                DefinitionsAssociationDefinitionFromObjectType = "AD"
	DefinitionsAssociationDefinitionFromObjectTypeAdAccount                         DefinitionsAssociationDefinitionFromObjectType = "AD_ACCOUNT"
	DefinitionsAssociationDefinitionFromObjectTypeAdCampaign                        DefinitionsAssociationDefinitionFromObjectType = "AD_CAMPAIGN"
	DefinitionsAssociationDefinitionFromObjectTypeAdGroup                           DefinitionsAssociationDefinitionFromObjectType = "AD_GROUP"
	DefinitionsAssociationDefinitionFromObjectTypeAIForecast                        DefinitionsAssociationDefinitionFromObjectType = "AI_FORECAST"
	DefinitionsAssociationDefinitionFromObjectTypeAllPages                          DefinitionsAssociationDefinitionFromObjectType = "ALL_PAGES"
	DefinitionsAssociationDefinitionFromObjectTypeApproval                          DefinitionsAssociationDefinitionFromObjectType = "APPROVAL"
	DefinitionsAssociationDefinitionFromObjectTypeApprovalStep                      DefinitionsAssociationDefinitionFromObjectType = "APPROVAL_STEP"
	DefinitionsAssociationDefinitionFromObjectTypeAttribution                       DefinitionsAssociationDefinitionFromObjectType = "ATTRIBUTION"
	DefinitionsAssociationDefinitionFromObjectTypeAudience                          DefinitionsAssociationDefinitionFromObjectType = "AUDIENCE"
	DefinitionsAssociationDefinitionFromObjectTypeAutomationJourney                 DefinitionsAssociationDefinitionFromObjectType = "AUTOMATION_JOURNEY"
	DefinitionsAssociationDefinitionFromObjectTypeAutomationPlatformFlow            DefinitionsAssociationDefinitionFromObjectType = "AUTOMATION_PLATFORM_FLOW"
	DefinitionsAssociationDefinitionFromObjectTypeAutomationPlatformFlowAction      DefinitionsAssociationDefinitionFromObjectType = "AUTOMATION_PLATFORM_FLOW_ACTION"
	DefinitionsAssociationDefinitionFromObjectTypeBetAlert                          DefinitionsAssociationDefinitionFromObjectType = "BET_ALERT"
	DefinitionsAssociationDefinitionFromObjectTypeBetDeliverableService             DefinitionsAssociationDefinitionFromObjectType = "BET_DELIVERABLE_SERVICE"
	DefinitionsAssociationDefinitionFromObjectTypeBlogListingPage                   DefinitionsAssociationDefinitionFromObjectType = "BLOG_LISTING_PAGE"
	DefinitionsAssociationDefinitionFromObjectTypeBlogPost                          DefinitionsAssociationDefinitionFromObjectType = "BLOG_POST"
	DefinitionsAssociationDefinitionFromObjectTypeCall                              DefinitionsAssociationDefinitionFromObjectType = "CALL"
	DefinitionsAssociationDefinitionFromObjectTypeCampaign                          DefinitionsAssociationDefinitionFromObjectType = "CAMPAIGN"
	DefinitionsAssociationDefinitionFromObjectTypeCampaignBudgetItem                DefinitionsAssociationDefinitionFromObjectType = "CAMPAIGN_BUDGET_ITEM"
	DefinitionsAssociationDefinitionFromObjectTypeCampaignSpendItem                 DefinitionsAssociationDefinitionFromObjectType = "CAMPAIGN_SPEND_ITEM"
	DefinitionsAssociationDefinitionFromObjectTypeCampaignStep                      DefinitionsAssociationDefinitionFromObjectType = "CAMPAIGN_STEP"
	DefinitionsAssociationDefinitionFromObjectTypeCampaignTemplate                  DefinitionsAssociationDefinitionFromObjectType = "CAMPAIGN_TEMPLATE"
	DefinitionsAssociationDefinitionFromObjectTypeCampaignTemplateStep              DefinitionsAssociationDefinitionFromObjectType = "CAMPAIGN_TEMPLATE_STEP"
	DefinitionsAssociationDefinitionFromObjectTypeCart                              DefinitionsAssociationDefinitionFromObjectType = "CART"
	DefinitionsAssociationDefinitionFromObjectTypeCaseStudy                         DefinitionsAssociationDefinitionFromObjectType = "CASE_STUDY"
	DefinitionsAssociationDefinitionFromObjectTypeChatflow                          DefinitionsAssociationDefinitionFromObjectType = "CHATFLOW"
	DefinitionsAssociationDefinitionFromObjectTypeClip                              DefinitionsAssociationDefinitionFromObjectType = "CLIP"
	DefinitionsAssociationDefinitionFromObjectTypeCmsURL                            DefinitionsAssociationDefinitionFromObjectType = "CMS_URL"
	DefinitionsAssociationDefinitionFromObjectTypeComboEventConfiguration           DefinitionsAssociationDefinitionFromObjectType = "COMBO_EVENT_CONFIGURATION"
	DefinitionsAssociationDefinitionFromObjectTypeCommercePayment                   DefinitionsAssociationDefinitionFromObjectType = "COMMERCE_PAYMENT"
	DefinitionsAssociationDefinitionFromObjectTypeCommunication                     DefinitionsAssociationDefinitionFromObjectType = "COMMUNICATION"
	DefinitionsAssociationDefinitionFromObjectTypeCompany                           DefinitionsAssociationDefinitionFromObjectType = "COMPANY"
	DefinitionsAssociationDefinitionFromObjectTypeContact                           DefinitionsAssociationDefinitionFromObjectType = "CONTACT"
	DefinitionsAssociationDefinitionFromObjectTypeContactCreateAttribution          DefinitionsAssociationDefinitionFromObjectType = "CONTACT_CREATE_ATTRIBUTION"
	DefinitionsAssociationDefinitionFromObjectTypeContent                           DefinitionsAssociationDefinitionFromObjectType = "CONTENT"
	DefinitionsAssociationDefinitionFromObjectTypeContentAudit                      DefinitionsAssociationDefinitionFromObjectType = "CONTENT_AUDIT"
	DefinitionsAssociationDefinitionFromObjectTypeContentAuditPage                  DefinitionsAssociationDefinitionFromObjectType = "CONTENT_AUDIT_PAGE"
	DefinitionsAssociationDefinitionFromObjectTypeConversation                      DefinitionsAssociationDefinitionFromObjectType = "CONVERSATION"
	DefinitionsAssociationDefinitionFromObjectTypeConversationInbox                 DefinitionsAssociationDefinitionFromObjectType = "CONVERSATION_INBOX"
	DefinitionsAssociationDefinitionFromObjectTypeConversationSession               DefinitionsAssociationDefinitionFromObjectType = "CONVERSATION_SESSION"
	DefinitionsAssociationDefinitionFromObjectTypeCrmObjectsDummyType               DefinitionsAssociationDefinitionFromObjectType = "CRM_OBJECTS_DUMMY_TYPE"
	DefinitionsAssociationDefinitionFromObjectTypeCrmPipelinesDummyType             DefinitionsAssociationDefinitionFromObjectType = "CRM_PIPELINES_DUMMY_TYPE"
	DefinitionsAssociationDefinitionFromObjectTypeCta                               DefinitionsAssociationDefinitionFromObjectType = "CTA"
	DefinitionsAssociationDefinitionFromObjectTypeCtaVariant                        DefinitionsAssociationDefinitionFromObjectType = "CTA_VARIANT"
	DefinitionsAssociationDefinitionFromObjectTypeDataPrivacyConsent                DefinitionsAssociationDefinitionFromObjectType = "DATA_PRIVACY_CONSENT"
	DefinitionsAssociationDefinitionFromObjectTypeDataSyncState                     DefinitionsAssociationDefinitionFromObjectType = "DATA_SYNC_STATE"
	DefinitionsAssociationDefinitionFromObjectTypeDeal                              DefinitionsAssociationDefinitionFromObjectType = "DEAL"
	DefinitionsAssociationDefinitionFromObjectTypeDealCreateAttribution             DefinitionsAssociationDefinitionFromObjectType = "DEAL_CREATE_ATTRIBUTION"
	DefinitionsAssociationDefinitionFromObjectTypeDealRegistration                  DefinitionsAssociationDefinitionFromObjectType = "DEAL_REGISTRATION"
	DefinitionsAssociationDefinitionFromObjectTypeDealSplit                         DefinitionsAssociationDefinitionFromObjectType = "DEAL_SPLIT"
	DefinitionsAssociationDefinitionFromObjectTypeDiscount                          DefinitionsAssociationDefinitionFromObjectType = "DISCOUNT"
	DefinitionsAssociationDefinitionFromObjectTypeDiscountCode                      DefinitionsAssociationDefinitionFromObjectType = "DISCOUNT_CODE"
	DefinitionsAssociationDefinitionFromObjectTypeDiscountTemplate                  DefinitionsAssociationDefinitionFromObjectType = "DISCOUNT_TEMPLATE"
	DefinitionsAssociationDefinitionFromObjectTypeEmail                             DefinitionsAssociationDefinitionFromObjectType = "EMAIL"
	DefinitionsAssociationDefinitionFromObjectTypeEngagement                        DefinitionsAssociationDefinitionFromObjectType = "ENGAGEMENT"
	DefinitionsAssociationDefinitionFromObjectTypeExport                            DefinitionsAssociationDefinitionFromObjectType = "EXPORT"
	DefinitionsAssociationDefinitionFromObjectTypeExternalWebURL                    DefinitionsAssociationDefinitionFromObjectType = "EXTERNAL_WEB_URL"
	DefinitionsAssociationDefinitionFromObjectTypeFee                               DefinitionsAssociationDefinitionFromObjectType = "FEE"
	DefinitionsAssociationDefinitionFromObjectTypeFeedbackSubmission                DefinitionsAssociationDefinitionFromObjectType = "FEEDBACK_SUBMISSION"
	DefinitionsAssociationDefinitionFromObjectTypeFeedbackSurvey                    DefinitionsAssociationDefinitionFromObjectType = "FEEDBACK_SURVEY"
	DefinitionsAssociationDefinitionFromObjectTypeFileManagerFile                   DefinitionsAssociationDefinitionFromObjectType = "FILE_MANAGER_FILE"
	DefinitionsAssociationDefinitionFromObjectTypeFileManagerFolder                 DefinitionsAssociationDefinitionFromObjectType = "FILE_MANAGER_FOLDER"
	DefinitionsAssociationDefinitionFromObjectTypeFolder                            DefinitionsAssociationDefinitionFromObjectType = "FOLDER"
	DefinitionsAssociationDefinitionFromObjectTypeForecast                          DefinitionsAssociationDefinitionFromObjectType = "FORECAST"
	DefinitionsAssociationDefinitionFromObjectTypeForm                              DefinitionsAssociationDefinitionFromObjectType = "FORM"
	DefinitionsAssociationDefinitionFromObjectTypeFormSubmissionInbounddb           DefinitionsAssociationDefinitionFromObjectType = "FORM_SUBMISSION_INBOUNDDB"
	DefinitionsAssociationDefinitionFromObjectTypeGoalTarget                        DefinitionsAssociationDefinitionFromObjectType = "GOAL_TARGET"
	DefinitionsAssociationDefinitionFromObjectTypeGoalTargetGroup                   DefinitionsAssociationDefinitionFromObjectType = "GOAL_TARGET_GROUP"
	DefinitionsAssociationDefinitionFromObjectTypeGoalTemplate                      DefinitionsAssociationDefinitionFromObjectType = "GOAL_TEMPLATE"
	DefinitionsAssociationDefinitionFromObjectTypeGscProperty                       DefinitionsAssociationDefinitionFromObjectType = "GSC_PROPERTY"
	DefinitionsAssociationDefinitionFromObjectTypeHub                               DefinitionsAssociationDefinitionFromObjectType = "HUB"
	DefinitionsAssociationDefinitionFromObjectTypeImport                            DefinitionsAssociationDefinitionFromObjectType = "IMPORT"
	DefinitionsAssociationDefinitionFromObjectTypeInvoice                           DefinitionsAssociationDefinitionFromObjectType = "INVOICE"
	DefinitionsAssociationDefinitionFromObjectTypeKeyword                           DefinitionsAssociationDefinitionFromObjectType = "KEYWORD"
	DefinitionsAssociationDefinitionFromObjectTypeKnowledgeArticle                  DefinitionsAssociationDefinitionFromObjectType = "KNOWLEDGE_ARTICLE"
	DefinitionsAssociationDefinitionFromObjectTypeLandingPage                       DefinitionsAssociationDefinitionFromObjectType = "LANDING_PAGE"
	DefinitionsAssociationDefinitionFromObjectTypeLead                              DefinitionsAssociationDefinitionFromObjectType = "LEAD"
	DefinitionsAssociationDefinitionFromObjectTypeLineItem                          DefinitionsAssociationDefinitionFromObjectType = "LINE_ITEM"
	DefinitionsAssociationDefinitionFromObjectTypeMarketingCalendar                 DefinitionsAssociationDefinitionFromObjectType = "MARKETING_CALENDAR"
	DefinitionsAssociationDefinitionFromObjectTypeMarketingCampaignUtm              DefinitionsAssociationDefinitionFromObjectType = "MARKETING_CAMPAIGN_UTM"
	DefinitionsAssociationDefinitionFromObjectTypeMarketingEmail                    DefinitionsAssociationDefinitionFromObjectType = "MARKETING_EMAIL"
	DefinitionsAssociationDefinitionFromObjectTypeMarketingEvent                    DefinitionsAssociationDefinitionFromObjectType = "MARKETING_EVENT"
	DefinitionsAssociationDefinitionFromObjectTypeMarketingEventAttendance          DefinitionsAssociationDefinitionFromObjectType = "MARKETING_EVENT_ATTENDANCE"
	DefinitionsAssociationDefinitionFromObjectTypeMarketingSMS                      DefinitionsAssociationDefinitionFromObjectType = "MARKETING_SMS"
	DefinitionsAssociationDefinitionFromObjectTypeMediaBridge                       DefinitionsAssociationDefinitionFromObjectType = "MEDIA_BRIDGE"
	DefinitionsAssociationDefinitionFromObjectTypeMeetingEvent                      DefinitionsAssociationDefinitionFromObjectType = "MEETING_EVENT"
	DefinitionsAssociationDefinitionFromObjectTypeMic                               DefinitionsAssociationDefinitionFromObjectType = "MIC"
	DefinitionsAssociationDefinitionFromObjectTypeNote                              DefinitionsAssociationDefinitionFromObjectType = "NOTE"
	DefinitionsAssociationDefinitionFromObjectTypeObjectList                        DefinitionsAssociationDefinitionFromObjectType = "OBJECT_LIST"
	DefinitionsAssociationDefinitionFromObjectTypeOrder                             DefinitionsAssociationDefinitionFromObjectType = "ORDER"
	DefinitionsAssociationDefinitionFromObjectTypeOwner                             DefinitionsAssociationDefinitionFromObjectType = "OWNER"
	DefinitionsAssociationDefinitionFromObjectTypePartnerAccount                    DefinitionsAssociationDefinitionFromObjectType = "PARTNER_ACCOUNT"
	DefinitionsAssociationDefinitionFromObjectTypePartnerClient                     DefinitionsAssociationDefinitionFromObjectType = "PARTNER_CLIENT"
	DefinitionsAssociationDefinitionFromObjectTypePartnerClientRevenue              DefinitionsAssociationDefinitionFromObjectType = "PARTNER_CLIENT_REVENUE"
	DefinitionsAssociationDefinitionFromObjectTypePartnerService                    DefinitionsAssociationDefinitionFromObjectType = "PARTNER_SERVICE"
	DefinitionsAssociationDefinitionFromObjectTypePaymentLink                       DefinitionsAssociationDefinitionFromObjectType = "PAYMENT_LINK"
	DefinitionsAssociationDefinitionFromObjectTypePaymentSchedule                   DefinitionsAssociationDefinitionFromObjectType = "PAYMENT_SCHEDULE"
	DefinitionsAssociationDefinitionFromObjectTypePaymentScheduleInstallment        DefinitionsAssociationDefinitionFromObjectType = "PAYMENT_SCHEDULE_INSTALLMENT"
	DefinitionsAssociationDefinitionFromObjectTypePermissionsTesting                DefinitionsAssociationDefinitionFromObjectType = "PERMISSIONS_TESTING"
	DefinitionsAssociationDefinitionFromObjectTypePlaybook                          DefinitionsAssociationDefinitionFromObjectType = "PLAYBOOK"
	DefinitionsAssociationDefinitionFromObjectTypePlaybookQuestion                  DefinitionsAssociationDefinitionFromObjectType = "PLAYBOOK_QUESTION"
	DefinitionsAssociationDefinitionFromObjectTypePlaybookSubmission                DefinitionsAssociationDefinitionFromObjectType = "PLAYBOOK_SUBMISSION"
	DefinitionsAssociationDefinitionFromObjectTypePlaybookSubmissionAnswer          DefinitionsAssociationDefinitionFromObjectType = "PLAYBOOK_SUBMISSION_ANSWER"
	DefinitionsAssociationDefinitionFromObjectTypePlaylist                          DefinitionsAssociationDefinitionFromObjectType = "PLAYLIST"
	DefinitionsAssociationDefinitionFromObjectTypePlaylistFolder                    DefinitionsAssociationDefinitionFromObjectType = "PLAYLIST_FOLDER"
	DefinitionsAssociationDefinitionFromObjectTypePodcastEpisode                    DefinitionsAssociationDefinitionFromObjectType = "PODCAST_EPISODE"
	DefinitionsAssociationDefinitionFromObjectTypePortal                            DefinitionsAssociationDefinitionFromObjectType = "PORTAL"
	DefinitionsAssociationDefinitionFromObjectTypePortalObjectSyncMessage           DefinitionsAssociationDefinitionFromObjectType = "PORTAL_OBJECT_SYNC_MESSAGE"
	DefinitionsAssociationDefinitionFromObjectTypePostalMail                        DefinitionsAssociationDefinitionFromObjectType = "POSTAL_MAIL"
	DefinitionsAssociationDefinitionFromObjectTypePrivacyScannerCookie              DefinitionsAssociationDefinitionFromObjectType = "PRIVACY_SCANNER_COOKIE"
	DefinitionsAssociationDefinitionFromObjectTypeProduct                           DefinitionsAssociationDefinitionFromObjectType = "PRODUCT"
	DefinitionsAssociationDefinitionFromObjectTypeProductOrFolder                   DefinitionsAssociationDefinitionFromObjectType = "PRODUCT_OR_FOLDER"
	DefinitionsAssociationDefinitionFromObjectTypePropertyInfo                      DefinitionsAssociationDefinitionFromObjectType = "PROPERTY_INFO"
	DefinitionsAssociationDefinitionFromObjectTypeProspectingAgentContactAssignment DefinitionsAssociationDefinitionFromObjectType = "PROSPECTING_AGENT_CONTACT_ASSIGNMENT"
	DefinitionsAssociationDefinitionFromObjectTypePublishingTask                    DefinitionsAssociationDefinitionFromObjectType = "PUBLISHING_TASK"
	DefinitionsAssociationDefinitionFromObjectTypeQuarantinedSubmission             DefinitionsAssociationDefinitionFromObjectType = "QUARANTINED_SUBMISSION"
	DefinitionsAssociationDefinitionFromObjectTypeQuota                             DefinitionsAssociationDefinitionFromObjectType = "QUOTA"
	DefinitionsAssociationDefinitionFromObjectTypeQuote                             DefinitionsAssociationDefinitionFromObjectType = "QUOTE"
	DefinitionsAssociationDefinitionFromObjectTypeQuoteField                        DefinitionsAssociationDefinitionFromObjectType = "QUOTE_FIELD"
	DefinitionsAssociationDefinitionFromObjectTypeQuoteModule                       DefinitionsAssociationDefinitionFromObjectType = "QUOTE_MODULE"
	DefinitionsAssociationDefinitionFromObjectTypeQuoteModuleField                  DefinitionsAssociationDefinitionFromObjectType = "QUOTE_MODULE_FIELD"
	DefinitionsAssociationDefinitionFromObjectTypeQuoteTemplate                     DefinitionsAssociationDefinitionFromObjectType = "QUOTE_TEMPLATE"
	DefinitionsAssociationDefinitionFromObjectTypeRestorableCrmObject               DefinitionsAssociationDefinitionFromObjectType = "RESTORABLE_CRM_OBJECT"
	DefinitionsAssociationDefinitionFromObjectTypeRoster                            DefinitionsAssociationDefinitionFromObjectType = "ROSTER"
	DefinitionsAssociationDefinitionFromObjectTypeRosterMember                      DefinitionsAssociationDefinitionFromObjectType = "ROSTER_MEMBER"
	DefinitionsAssociationDefinitionFromObjectTypeSalesDocument                     DefinitionsAssociationDefinitionFromObjectType = "SALES_DOCUMENT"
	DefinitionsAssociationDefinitionFromObjectTypeSalesTask                         DefinitionsAssociationDefinitionFromObjectType = "SALES_TASK"
	DefinitionsAssociationDefinitionFromObjectTypeSalesWorkload                     DefinitionsAssociationDefinitionFromObjectType = "SALES_WORKLOAD"
	DefinitionsAssociationDefinitionFromObjectTypeSalesforceSyncError               DefinitionsAssociationDefinitionFromObjectType = "SALESFORCE_SYNC_ERROR"
	DefinitionsAssociationDefinitionFromObjectTypeSchedulingPage                    DefinitionsAssociationDefinitionFromObjectType = "SCHEDULING_PAGE"
	DefinitionsAssociationDefinitionFromObjectTypeSchemasBackendTest                DefinitionsAssociationDefinitionFromObjectType = "SCHEMAS_BACKEND_TEST"
	DefinitionsAssociationDefinitionFromObjectTypeScoreConfiguration                DefinitionsAssociationDefinitionFromObjectType = "SCORE_CONFIGURATION"
	DefinitionsAssociationDefinitionFromObjectTypeSequence                          DefinitionsAssociationDefinitionFromObjectType = "SEQUENCE"
	DefinitionsAssociationDefinitionFromObjectTypeSequenceEnrollment                DefinitionsAssociationDefinitionFromObjectType = "SEQUENCE_ENROLLMENT"
	DefinitionsAssociationDefinitionFromObjectTypeSequenceStep                      DefinitionsAssociationDefinitionFromObjectType = "SEQUENCE_STEP"
	DefinitionsAssociationDefinitionFromObjectTypeSequenceStepEnrollment            DefinitionsAssociationDefinitionFromObjectType = "SEQUENCE_STEP_ENROLLMENT"
	DefinitionsAssociationDefinitionFromObjectTypeService                           DefinitionsAssociationDefinitionFromObjectType = "SERVICE"
	DefinitionsAssociationDefinitionFromObjectTypeSitePage                          DefinitionsAssociationDefinitionFromObjectType = "SITE_PAGE"
	DefinitionsAssociationDefinitionFromObjectTypeSnippet                           DefinitionsAssociationDefinitionFromObjectType = "SNIPPET"
	DefinitionsAssociationDefinitionFromObjectTypeSocialBroadcast                   DefinitionsAssociationDefinitionFromObjectType = "SOCIAL_BROADCAST"
	DefinitionsAssociationDefinitionFromObjectTypeSocialChannel                     DefinitionsAssociationDefinitionFromObjectType = "SOCIAL_CHANNEL"
	DefinitionsAssociationDefinitionFromObjectTypeSocialPost                        DefinitionsAssociationDefinitionFromObjectType = "SOCIAL_POST"
	DefinitionsAssociationDefinitionFromObjectTypeSocialProfile                     DefinitionsAssociationDefinitionFromObjectType = "SOCIAL_PROFILE"
	DefinitionsAssociationDefinitionFromObjectTypeSoxProtectedDummyType             DefinitionsAssociationDefinitionFromObjectType = "SOX_PROTECTED_DUMMY_TYPE"
	DefinitionsAssociationDefinitionFromObjectTypeSoxProtectedTestType              DefinitionsAssociationDefinitionFromObjectType = "SOX_PROTECTED_TEST_TYPE"
	DefinitionsAssociationDefinitionFromObjectTypeSubmissionTag                     DefinitionsAssociationDefinitionFromObjectType = "SUBMISSION_TAG"
	DefinitionsAssociationDefinitionFromObjectTypeSubscription                      DefinitionsAssociationDefinitionFromObjectType = "SUBSCRIPTION"
	DefinitionsAssociationDefinitionFromObjectTypeTask                              DefinitionsAssociationDefinitionFromObjectType = "TASK"
	DefinitionsAssociationDefinitionFromObjectTypeTaskTemplate                      DefinitionsAssociationDefinitionFromObjectType = "TASK_TEMPLATE"
	DefinitionsAssociationDefinitionFromObjectTypeTax                               DefinitionsAssociationDefinitionFromObjectType = "TAX"
	DefinitionsAssociationDefinitionFromObjectTypeTemplate                          DefinitionsAssociationDefinitionFromObjectType = "TEMPLATE"
	DefinitionsAssociationDefinitionFromObjectTypeTicket                            DefinitionsAssociationDefinitionFromObjectType = "TICKET"
	DefinitionsAssociationDefinitionFromObjectTypeUnknown                           DefinitionsAssociationDefinitionFromObjectType = "UNKNOWN"
	DefinitionsAssociationDefinitionFromObjectTypeUnsubscribe                       DefinitionsAssociationDefinitionFromObjectType = "UNSUBSCRIBE"
	DefinitionsAssociationDefinitionFromObjectTypeUser                              DefinitionsAssociationDefinitionFromObjectType = "USER"
	DefinitionsAssociationDefinitionFromObjectTypeView                              DefinitionsAssociationDefinitionFromObjectType = "VIEW"
	DefinitionsAssociationDefinitionFromObjectTypeViewBlock                         DefinitionsAssociationDefinitionFromObjectType = "VIEW_BLOCK"
	DefinitionsAssociationDefinitionFromObjectTypeWebInteractive                    DefinitionsAssociationDefinitionFromObjectType = "WEB_INTERACTIVE"
)

type DefinitionsAssociationDefinitionHiddenReason string

const (
	DefinitionsAssociationDefinitionHiddenReasonDefault        DefinitionsAssociationDefinitionHiddenReason = "DEFAULT"
	DefinitionsAssociationDefinitionHiddenReasonInternal       DefinitionsAssociationDefinitionHiddenReason = "INTERNAL"
	DefinitionsAssociationDefinitionHiddenReasonUserConfigured DefinitionsAssociationDefinitionHiddenReason = "USER_CONFIGURED"
)

// The name of the destination object type (e.g,. "DEAL" or "QUOTE").
type DefinitionsAssociationDefinitionToObjectType string

const (
	DefinitionsAssociationDefinitionToObjectTypeAbandonedCart                     DefinitionsAssociationDefinitionToObjectType = "ABANDONED_CART"
	DefinitionsAssociationDefinitionToObjectTypeAcceptanceTest                    DefinitionsAssociationDefinitionToObjectType = "ACCEPTANCE_TEST"
	DefinitionsAssociationDefinitionToObjectTypeAd                                DefinitionsAssociationDefinitionToObjectType = "AD"
	DefinitionsAssociationDefinitionToObjectTypeAdAccount                         DefinitionsAssociationDefinitionToObjectType = "AD_ACCOUNT"
	DefinitionsAssociationDefinitionToObjectTypeAdCampaign                        DefinitionsAssociationDefinitionToObjectType = "AD_CAMPAIGN"
	DefinitionsAssociationDefinitionToObjectTypeAdGroup                           DefinitionsAssociationDefinitionToObjectType = "AD_GROUP"
	DefinitionsAssociationDefinitionToObjectTypeAIForecast                        DefinitionsAssociationDefinitionToObjectType = "AI_FORECAST"
	DefinitionsAssociationDefinitionToObjectTypeAllPages                          DefinitionsAssociationDefinitionToObjectType = "ALL_PAGES"
	DefinitionsAssociationDefinitionToObjectTypeApproval                          DefinitionsAssociationDefinitionToObjectType = "APPROVAL"
	DefinitionsAssociationDefinitionToObjectTypeApprovalStep                      DefinitionsAssociationDefinitionToObjectType = "APPROVAL_STEP"
	DefinitionsAssociationDefinitionToObjectTypeAttribution                       DefinitionsAssociationDefinitionToObjectType = "ATTRIBUTION"
	DefinitionsAssociationDefinitionToObjectTypeAudience                          DefinitionsAssociationDefinitionToObjectType = "AUDIENCE"
	DefinitionsAssociationDefinitionToObjectTypeAutomationJourney                 DefinitionsAssociationDefinitionToObjectType = "AUTOMATION_JOURNEY"
	DefinitionsAssociationDefinitionToObjectTypeAutomationPlatformFlow            DefinitionsAssociationDefinitionToObjectType = "AUTOMATION_PLATFORM_FLOW"
	DefinitionsAssociationDefinitionToObjectTypeAutomationPlatformFlowAction      DefinitionsAssociationDefinitionToObjectType = "AUTOMATION_PLATFORM_FLOW_ACTION"
	DefinitionsAssociationDefinitionToObjectTypeBetAlert                          DefinitionsAssociationDefinitionToObjectType = "BET_ALERT"
	DefinitionsAssociationDefinitionToObjectTypeBetDeliverableService             DefinitionsAssociationDefinitionToObjectType = "BET_DELIVERABLE_SERVICE"
	DefinitionsAssociationDefinitionToObjectTypeBlogListingPage                   DefinitionsAssociationDefinitionToObjectType = "BLOG_LISTING_PAGE"
	DefinitionsAssociationDefinitionToObjectTypeBlogPost                          DefinitionsAssociationDefinitionToObjectType = "BLOG_POST"
	DefinitionsAssociationDefinitionToObjectTypeCall                              DefinitionsAssociationDefinitionToObjectType = "CALL"
	DefinitionsAssociationDefinitionToObjectTypeCampaign                          DefinitionsAssociationDefinitionToObjectType = "CAMPAIGN"
	DefinitionsAssociationDefinitionToObjectTypeCampaignBudgetItem                DefinitionsAssociationDefinitionToObjectType = "CAMPAIGN_BUDGET_ITEM"
	DefinitionsAssociationDefinitionToObjectTypeCampaignSpendItem                 DefinitionsAssociationDefinitionToObjectType = "CAMPAIGN_SPEND_ITEM"
	DefinitionsAssociationDefinitionToObjectTypeCampaignStep                      DefinitionsAssociationDefinitionToObjectType = "CAMPAIGN_STEP"
	DefinitionsAssociationDefinitionToObjectTypeCampaignTemplate                  DefinitionsAssociationDefinitionToObjectType = "CAMPAIGN_TEMPLATE"
	DefinitionsAssociationDefinitionToObjectTypeCampaignTemplateStep              DefinitionsAssociationDefinitionToObjectType = "CAMPAIGN_TEMPLATE_STEP"
	DefinitionsAssociationDefinitionToObjectTypeCart                              DefinitionsAssociationDefinitionToObjectType = "CART"
	DefinitionsAssociationDefinitionToObjectTypeCaseStudy                         DefinitionsAssociationDefinitionToObjectType = "CASE_STUDY"
	DefinitionsAssociationDefinitionToObjectTypeChatflow                          DefinitionsAssociationDefinitionToObjectType = "CHATFLOW"
	DefinitionsAssociationDefinitionToObjectTypeClip                              DefinitionsAssociationDefinitionToObjectType = "CLIP"
	DefinitionsAssociationDefinitionToObjectTypeCmsURL                            DefinitionsAssociationDefinitionToObjectType = "CMS_URL"
	DefinitionsAssociationDefinitionToObjectTypeComboEventConfiguration           DefinitionsAssociationDefinitionToObjectType = "COMBO_EVENT_CONFIGURATION"
	DefinitionsAssociationDefinitionToObjectTypeCommercePayment                   DefinitionsAssociationDefinitionToObjectType = "COMMERCE_PAYMENT"
	DefinitionsAssociationDefinitionToObjectTypeCommunication                     DefinitionsAssociationDefinitionToObjectType = "COMMUNICATION"
	DefinitionsAssociationDefinitionToObjectTypeCompany                           DefinitionsAssociationDefinitionToObjectType = "COMPANY"
	DefinitionsAssociationDefinitionToObjectTypeContact                           DefinitionsAssociationDefinitionToObjectType = "CONTACT"
	DefinitionsAssociationDefinitionToObjectTypeContactCreateAttribution          DefinitionsAssociationDefinitionToObjectType = "CONTACT_CREATE_ATTRIBUTION"
	DefinitionsAssociationDefinitionToObjectTypeContent                           DefinitionsAssociationDefinitionToObjectType = "CONTENT"
	DefinitionsAssociationDefinitionToObjectTypeContentAudit                      DefinitionsAssociationDefinitionToObjectType = "CONTENT_AUDIT"
	DefinitionsAssociationDefinitionToObjectTypeContentAuditPage                  DefinitionsAssociationDefinitionToObjectType = "CONTENT_AUDIT_PAGE"
	DefinitionsAssociationDefinitionToObjectTypeConversation                      DefinitionsAssociationDefinitionToObjectType = "CONVERSATION"
	DefinitionsAssociationDefinitionToObjectTypeConversationInbox                 DefinitionsAssociationDefinitionToObjectType = "CONVERSATION_INBOX"
	DefinitionsAssociationDefinitionToObjectTypeConversationSession               DefinitionsAssociationDefinitionToObjectType = "CONVERSATION_SESSION"
	DefinitionsAssociationDefinitionToObjectTypeCrmObjectsDummyType               DefinitionsAssociationDefinitionToObjectType = "CRM_OBJECTS_DUMMY_TYPE"
	DefinitionsAssociationDefinitionToObjectTypeCrmPipelinesDummyType             DefinitionsAssociationDefinitionToObjectType = "CRM_PIPELINES_DUMMY_TYPE"
	DefinitionsAssociationDefinitionToObjectTypeCta                               DefinitionsAssociationDefinitionToObjectType = "CTA"
	DefinitionsAssociationDefinitionToObjectTypeCtaVariant                        DefinitionsAssociationDefinitionToObjectType = "CTA_VARIANT"
	DefinitionsAssociationDefinitionToObjectTypeDataPrivacyConsent                DefinitionsAssociationDefinitionToObjectType = "DATA_PRIVACY_CONSENT"
	DefinitionsAssociationDefinitionToObjectTypeDataSyncState                     DefinitionsAssociationDefinitionToObjectType = "DATA_SYNC_STATE"
	DefinitionsAssociationDefinitionToObjectTypeDeal                              DefinitionsAssociationDefinitionToObjectType = "DEAL"
	DefinitionsAssociationDefinitionToObjectTypeDealCreateAttribution             DefinitionsAssociationDefinitionToObjectType = "DEAL_CREATE_ATTRIBUTION"
	DefinitionsAssociationDefinitionToObjectTypeDealRegistration                  DefinitionsAssociationDefinitionToObjectType = "DEAL_REGISTRATION"
	DefinitionsAssociationDefinitionToObjectTypeDealSplit                         DefinitionsAssociationDefinitionToObjectType = "DEAL_SPLIT"
	DefinitionsAssociationDefinitionToObjectTypeDiscount                          DefinitionsAssociationDefinitionToObjectType = "DISCOUNT"
	DefinitionsAssociationDefinitionToObjectTypeDiscountCode                      DefinitionsAssociationDefinitionToObjectType = "DISCOUNT_CODE"
	DefinitionsAssociationDefinitionToObjectTypeDiscountTemplate                  DefinitionsAssociationDefinitionToObjectType = "DISCOUNT_TEMPLATE"
	DefinitionsAssociationDefinitionToObjectTypeEmail                             DefinitionsAssociationDefinitionToObjectType = "EMAIL"
	DefinitionsAssociationDefinitionToObjectTypeEngagement                        DefinitionsAssociationDefinitionToObjectType = "ENGAGEMENT"
	DefinitionsAssociationDefinitionToObjectTypeExport                            DefinitionsAssociationDefinitionToObjectType = "EXPORT"
	DefinitionsAssociationDefinitionToObjectTypeExternalWebURL                    DefinitionsAssociationDefinitionToObjectType = "EXTERNAL_WEB_URL"
	DefinitionsAssociationDefinitionToObjectTypeFee                               DefinitionsAssociationDefinitionToObjectType = "FEE"
	DefinitionsAssociationDefinitionToObjectTypeFeedbackSubmission                DefinitionsAssociationDefinitionToObjectType = "FEEDBACK_SUBMISSION"
	DefinitionsAssociationDefinitionToObjectTypeFeedbackSurvey                    DefinitionsAssociationDefinitionToObjectType = "FEEDBACK_SURVEY"
	DefinitionsAssociationDefinitionToObjectTypeFileManagerFile                   DefinitionsAssociationDefinitionToObjectType = "FILE_MANAGER_FILE"
	DefinitionsAssociationDefinitionToObjectTypeFileManagerFolder                 DefinitionsAssociationDefinitionToObjectType = "FILE_MANAGER_FOLDER"
	DefinitionsAssociationDefinitionToObjectTypeFolder                            DefinitionsAssociationDefinitionToObjectType = "FOLDER"
	DefinitionsAssociationDefinitionToObjectTypeForecast                          DefinitionsAssociationDefinitionToObjectType = "FORECAST"
	DefinitionsAssociationDefinitionToObjectTypeForm                              DefinitionsAssociationDefinitionToObjectType = "FORM"
	DefinitionsAssociationDefinitionToObjectTypeFormSubmissionInbounddb           DefinitionsAssociationDefinitionToObjectType = "FORM_SUBMISSION_INBOUNDDB"
	DefinitionsAssociationDefinitionToObjectTypeGoalTarget                        DefinitionsAssociationDefinitionToObjectType = "GOAL_TARGET"
	DefinitionsAssociationDefinitionToObjectTypeGoalTargetGroup                   DefinitionsAssociationDefinitionToObjectType = "GOAL_TARGET_GROUP"
	DefinitionsAssociationDefinitionToObjectTypeGoalTemplate                      DefinitionsAssociationDefinitionToObjectType = "GOAL_TEMPLATE"
	DefinitionsAssociationDefinitionToObjectTypeGscProperty                       DefinitionsAssociationDefinitionToObjectType = "GSC_PROPERTY"
	DefinitionsAssociationDefinitionToObjectTypeHub                               DefinitionsAssociationDefinitionToObjectType = "HUB"
	DefinitionsAssociationDefinitionToObjectTypeImport                            DefinitionsAssociationDefinitionToObjectType = "IMPORT"
	DefinitionsAssociationDefinitionToObjectTypeInvoice                           DefinitionsAssociationDefinitionToObjectType = "INVOICE"
	DefinitionsAssociationDefinitionToObjectTypeKeyword                           DefinitionsAssociationDefinitionToObjectType = "KEYWORD"
	DefinitionsAssociationDefinitionToObjectTypeKnowledgeArticle                  DefinitionsAssociationDefinitionToObjectType = "KNOWLEDGE_ARTICLE"
	DefinitionsAssociationDefinitionToObjectTypeLandingPage                       DefinitionsAssociationDefinitionToObjectType = "LANDING_PAGE"
	DefinitionsAssociationDefinitionToObjectTypeLead                              DefinitionsAssociationDefinitionToObjectType = "LEAD"
	DefinitionsAssociationDefinitionToObjectTypeLineItem                          DefinitionsAssociationDefinitionToObjectType = "LINE_ITEM"
	DefinitionsAssociationDefinitionToObjectTypeMarketingCalendar                 DefinitionsAssociationDefinitionToObjectType = "MARKETING_CALENDAR"
	DefinitionsAssociationDefinitionToObjectTypeMarketingCampaignUtm              DefinitionsAssociationDefinitionToObjectType = "MARKETING_CAMPAIGN_UTM"
	DefinitionsAssociationDefinitionToObjectTypeMarketingEmail                    DefinitionsAssociationDefinitionToObjectType = "MARKETING_EMAIL"
	DefinitionsAssociationDefinitionToObjectTypeMarketingEvent                    DefinitionsAssociationDefinitionToObjectType = "MARKETING_EVENT"
	DefinitionsAssociationDefinitionToObjectTypeMarketingEventAttendance          DefinitionsAssociationDefinitionToObjectType = "MARKETING_EVENT_ATTENDANCE"
	DefinitionsAssociationDefinitionToObjectTypeMarketingSMS                      DefinitionsAssociationDefinitionToObjectType = "MARKETING_SMS"
	DefinitionsAssociationDefinitionToObjectTypeMediaBridge                       DefinitionsAssociationDefinitionToObjectType = "MEDIA_BRIDGE"
	DefinitionsAssociationDefinitionToObjectTypeMeetingEvent                      DefinitionsAssociationDefinitionToObjectType = "MEETING_EVENT"
	DefinitionsAssociationDefinitionToObjectTypeMic                               DefinitionsAssociationDefinitionToObjectType = "MIC"
	DefinitionsAssociationDefinitionToObjectTypeNote                              DefinitionsAssociationDefinitionToObjectType = "NOTE"
	DefinitionsAssociationDefinitionToObjectTypeObjectList                        DefinitionsAssociationDefinitionToObjectType = "OBJECT_LIST"
	DefinitionsAssociationDefinitionToObjectTypeOrder                             DefinitionsAssociationDefinitionToObjectType = "ORDER"
	DefinitionsAssociationDefinitionToObjectTypeOwner                             DefinitionsAssociationDefinitionToObjectType = "OWNER"
	DefinitionsAssociationDefinitionToObjectTypePartnerAccount                    DefinitionsAssociationDefinitionToObjectType = "PARTNER_ACCOUNT"
	DefinitionsAssociationDefinitionToObjectTypePartnerClient                     DefinitionsAssociationDefinitionToObjectType = "PARTNER_CLIENT"
	DefinitionsAssociationDefinitionToObjectTypePartnerClientRevenue              DefinitionsAssociationDefinitionToObjectType = "PARTNER_CLIENT_REVENUE"
	DefinitionsAssociationDefinitionToObjectTypePartnerService                    DefinitionsAssociationDefinitionToObjectType = "PARTNER_SERVICE"
	DefinitionsAssociationDefinitionToObjectTypePaymentLink                       DefinitionsAssociationDefinitionToObjectType = "PAYMENT_LINK"
	DefinitionsAssociationDefinitionToObjectTypePaymentSchedule                   DefinitionsAssociationDefinitionToObjectType = "PAYMENT_SCHEDULE"
	DefinitionsAssociationDefinitionToObjectTypePaymentScheduleInstallment        DefinitionsAssociationDefinitionToObjectType = "PAYMENT_SCHEDULE_INSTALLMENT"
	DefinitionsAssociationDefinitionToObjectTypePermissionsTesting                DefinitionsAssociationDefinitionToObjectType = "PERMISSIONS_TESTING"
	DefinitionsAssociationDefinitionToObjectTypePlaybook                          DefinitionsAssociationDefinitionToObjectType = "PLAYBOOK"
	DefinitionsAssociationDefinitionToObjectTypePlaybookQuestion                  DefinitionsAssociationDefinitionToObjectType = "PLAYBOOK_QUESTION"
	DefinitionsAssociationDefinitionToObjectTypePlaybookSubmission                DefinitionsAssociationDefinitionToObjectType = "PLAYBOOK_SUBMISSION"
	DefinitionsAssociationDefinitionToObjectTypePlaybookSubmissionAnswer          DefinitionsAssociationDefinitionToObjectType = "PLAYBOOK_SUBMISSION_ANSWER"
	DefinitionsAssociationDefinitionToObjectTypePlaylist                          DefinitionsAssociationDefinitionToObjectType = "PLAYLIST"
	DefinitionsAssociationDefinitionToObjectTypePlaylistFolder                    DefinitionsAssociationDefinitionToObjectType = "PLAYLIST_FOLDER"
	DefinitionsAssociationDefinitionToObjectTypePodcastEpisode                    DefinitionsAssociationDefinitionToObjectType = "PODCAST_EPISODE"
	DefinitionsAssociationDefinitionToObjectTypePortal                            DefinitionsAssociationDefinitionToObjectType = "PORTAL"
	DefinitionsAssociationDefinitionToObjectTypePortalObjectSyncMessage           DefinitionsAssociationDefinitionToObjectType = "PORTAL_OBJECT_SYNC_MESSAGE"
	DefinitionsAssociationDefinitionToObjectTypePostalMail                        DefinitionsAssociationDefinitionToObjectType = "POSTAL_MAIL"
	DefinitionsAssociationDefinitionToObjectTypePrivacyScannerCookie              DefinitionsAssociationDefinitionToObjectType = "PRIVACY_SCANNER_COOKIE"
	DefinitionsAssociationDefinitionToObjectTypeProduct                           DefinitionsAssociationDefinitionToObjectType = "PRODUCT"
	DefinitionsAssociationDefinitionToObjectTypeProductOrFolder                   DefinitionsAssociationDefinitionToObjectType = "PRODUCT_OR_FOLDER"
	DefinitionsAssociationDefinitionToObjectTypePropertyInfo                      DefinitionsAssociationDefinitionToObjectType = "PROPERTY_INFO"
	DefinitionsAssociationDefinitionToObjectTypeProspectingAgentContactAssignment DefinitionsAssociationDefinitionToObjectType = "PROSPECTING_AGENT_CONTACT_ASSIGNMENT"
	DefinitionsAssociationDefinitionToObjectTypePublishingTask                    DefinitionsAssociationDefinitionToObjectType = "PUBLISHING_TASK"
	DefinitionsAssociationDefinitionToObjectTypeQuarantinedSubmission             DefinitionsAssociationDefinitionToObjectType = "QUARANTINED_SUBMISSION"
	DefinitionsAssociationDefinitionToObjectTypeQuota                             DefinitionsAssociationDefinitionToObjectType = "QUOTA"
	DefinitionsAssociationDefinitionToObjectTypeQuote                             DefinitionsAssociationDefinitionToObjectType = "QUOTE"
	DefinitionsAssociationDefinitionToObjectTypeQuoteField                        DefinitionsAssociationDefinitionToObjectType = "QUOTE_FIELD"
	DefinitionsAssociationDefinitionToObjectTypeQuoteModule                       DefinitionsAssociationDefinitionToObjectType = "QUOTE_MODULE"
	DefinitionsAssociationDefinitionToObjectTypeQuoteModuleField                  DefinitionsAssociationDefinitionToObjectType = "QUOTE_MODULE_FIELD"
	DefinitionsAssociationDefinitionToObjectTypeQuoteTemplate                     DefinitionsAssociationDefinitionToObjectType = "QUOTE_TEMPLATE"
	DefinitionsAssociationDefinitionToObjectTypeRestorableCrmObject               DefinitionsAssociationDefinitionToObjectType = "RESTORABLE_CRM_OBJECT"
	DefinitionsAssociationDefinitionToObjectTypeRoster                            DefinitionsAssociationDefinitionToObjectType = "ROSTER"
	DefinitionsAssociationDefinitionToObjectTypeRosterMember                      DefinitionsAssociationDefinitionToObjectType = "ROSTER_MEMBER"
	DefinitionsAssociationDefinitionToObjectTypeSalesDocument                     DefinitionsAssociationDefinitionToObjectType = "SALES_DOCUMENT"
	DefinitionsAssociationDefinitionToObjectTypeSalesTask                         DefinitionsAssociationDefinitionToObjectType = "SALES_TASK"
	DefinitionsAssociationDefinitionToObjectTypeSalesWorkload                     DefinitionsAssociationDefinitionToObjectType = "SALES_WORKLOAD"
	DefinitionsAssociationDefinitionToObjectTypeSalesforceSyncError               DefinitionsAssociationDefinitionToObjectType = "SALESFORCE_SYNC_ERROR"
	DefinitionsAssociationDefinitionToObjectTypeSchedulingPage                    DefinitionsAssociationDefinitionToObjectType = "SCHEDULING_PAGE"
	DefinitionsAssociationDefinitionToObjectTypeSchemasBackendTest                DefinitionsAssociationDefinitionToObjectType = "SCHEMAS_BACKEND_TEST"
	DefinitionsAssociationDefinitionToObjectTypeScoreConfiguration                DefinitionsAssociationDefinitionToObjectType = "SCORE_CONFIGURATION"
	DefinitionsAssociationDefinitionToObjectTypeSequence                          DefinitionsAssociationDefinitionToObjectType = "SEQUENCE"
	DefinitionsAssociationDefinitionToObjectTypeSequenceEnrollment                DefinitionsAssociationDefinitionToObjectType = "SEQUENCE_ENROLLMENT"
	DefinitionsAssociationDefinitionToObjectTypeSequenceStep                      DefinitionsAssociationDefinitionToObjectType = "SEQUENCE_STEP"
	DefinitionsAssociationDefinitionToObjectTypeSequenceStepEnrollment            DefinitionsAssociationDefinitionToObjectType = "SEQUENCE_STEP_ENROLLMENT"
	DefinitionsAssociationDefinitionToObjectTypeService                           DefinitionsAssociationDefinitionToObjectType = "SERVICE"
	DefinitionsAssociationDefinitionToObjectTypeSitePage                          DefinitionsAssociationDefinitionToObjectType = "SITE_PAGE"
	DefinitionsAssociationDefinitionToObjectTypeSnippet                           DefinitionsAssociationDefinitionToObjectType = "SNIPPET"
	DefinitionsAssociationDefinitionToObjectTypeSocialBroadcast                   DefinitionsAssociationDefinitionToObjectType = "SOCIAL_BROADCAST"
	DefinitionsAssociationDefinitionToObjectTypeSocialChannel                     DefinitionsAssociationDefinitionToObjectType = "SOCIAL_CHANNEL"
	DefinitionsAssociationDefinitionToObjectTypeSocialPost                        DefinitionsAssociationDefinitionToObjectType = "SOCIAL_POST"
	DefinitionsAssociationDefinitionToObjectTypeSocialProfile                     DefinitionsAssociationDefinitionToObjectType = "SOCIAL_PROFILE"
	DefinitionsAssociationDefinitionToObjectTypeSoxProtectedDummyType             DefinitionsAssociationDefinitionToObjectType = "SOX_PROTECTED_DUMMY_TYPE"
	DefinitionsAssociationDefinitionToObjectTypeSoxProtectedTestType              DefinitionsAssociationDefinitionToObjectType = "SOX_PROTECTED_TEST_TYPE"
	DefinitionsAssociationDefinitionToObjectTypeSubmissionTag                     DefinitionsAssociationDefinitionToObjectType = "SUBMISSION_TAG"
	DefinitionsAssociationDefinitionToObjectTypeSubscription                      DefinitionsAssociationDefinitionToObjectType = "SUBSCRIPTION"
	DefinitionsAssociationDefinitionToObjectTypeTask                              DefinitionsAssociationDefinitionToObjectType = "TASK"
	DefinitionsAssociationDefinitionToObjectTypeTaskTemplate                      DefinitionsAssociationDefinitionToObjectType = "TASK_TEMPLATE"
	DefinitionsAssociationDefinitionToObjectTypeTax                               DefinitionsAssociationDefinitionToObjectType = "TAX"
	DefinitionsAssociationDefinitionToObjectTypeTemplate                          DefinitionsAssociationDefinitionToObjectType = "TEMPLATE"
	DefinitionsAssociationDefinitionToObjectTypeTicket                            DefinitionsAssociationDefinitionToObjectType = "TICKET"
	DefinitionsAssociationDefinitionToObjectTypeUnknown                           DefinitionsAssociationDefinitionToObjectType = "UNKNOWN"
	DefinitionsAssociationDefinitionToObjectTypeUnsubscribe                       DefinitionsAssociationDefinitionToObjectType = "UNSUBSCRIBE"
	DefinitionsAssociationDefinitionToObjectTypeUser                              DefinitionsAssociationDefinitionToObjectType = "USER"
	DefinitionsAssociationDefinitionToObjectTypeView                              DefinitionsAssociationDefinitionToObjectType = "VIEW"
	DefinitionsAssociationDefinitionToObjectTypeViewBlock                         DefinitionsAssociationDefinitionToObjectType = "VIEW_BLOCK"
	DefinitionsAssociationDefinitionToObjectTypeWebInteractive                    DefinitionsAssociationDefinitionToObjectType = "WEB_INTERACTIVE"
)
...
type ExternalBehavioralEventTypeDefinition struct {
	...
	Associations       []DefinitionsAssociationDefinition      `json:"associations" api:"required"`
	...
	// "CUSTOM_SCRIPT", "CUSTOM_SIGNAL", "IMPORT", "MANUAL", "PROPERTY_CHANGE",
	// "VISITED_URL", "WEBHOOK".
...
const (
	...
	ExternalBehavioralEventTypeDefinitionTrackingTypeCustomSignal     ExternalBehavioralEventTypeDefinitionTrackingType = "CUSTOM_SIGNAL"
...
type DefinitionNewPropertyParams struct {
	ExternalBehavioralEventPropertyCreate ExternalBehavioralEventPropertyCreateParam
	paramObj
}

func (r DefinitionNewPropertyParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.ExternalBehavioralEventPropertyCreate)
}
func (r *DefinitionNewPropertyParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type DefinitionDeletePropertyParams struct {
	EventName string `path:"eventName" api:"required" json:"-"`
	paramObj
}

type DefinitionSendBatchParams struct {
	BatchedBehavioralEventHTTPCompletionRequest BatchedBehavioralEventHTTPCompletionRequestParam
	paramObj
}

func (r DefinitionSendBatchParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.BatchedBehavioralEventHTTPCompletionRequest)
}
func (r *DefinitionSendBatchParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type DefinitionUpdatePropertyParams struct {
	EventName                                      string `path:"eventName" api:"required" json:"-"`
	ExternalBehavioralEventPropertyDefinitionPatch ExternalBehavioralEventPropertyDefinitionPatchParam
	paramObj
}

func (r DefinitionUpdatePropertyParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.ExternalBehavioralEventPropertyDefinitionPatch)
}
func (r *DefinitionUpdatePropertyParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
