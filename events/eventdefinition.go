...
// EventDefinitionService contains methods and other services that help with
// interacting with the hubspot API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewEventDefinitionService] method instead.
type EventDefinitionService struct {
	Options []option.RequestOption
}

// NewEventDefinitionService generates a new service that applies the given options
// to each request. These options are applied after the parent client's options (if
// there is one), and before any request-specific options.
func NewEventDefinitionService(opts ...option.RequestOption) (r EventDefinitionService) {
	r = EventDefinitionService{}
	r.Options = opts
	return
}

// Create a custom event definition.
func (r *EventDefinitionService) New(ctx context.Context, body EventDefinitionNewParams, opts ...option.RequestOption) (res *ExternalBehavioralEventTypeDefinition, err error) {
...
func (r *EventDefinitionService) Update(ctx context.Context, eventName string, body EventDefinitionUpdateParams, opts ...option.RequestOption) (res *ExternalBehavioralEventTypeDefinition, err error) {
	opts = slices.Concat(r.Options, opts)
	if eventName == "" {
		err = errors.New("missing required eventName parameter")
		return
	}
	path := fmt.Sprintf("events/v3/event-definitions/%s", eventName)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPatch, path, body, &res, opts...)
	return
}

// Retrieve existing custom event definitions.
func (r *EventDefinitionService) List(ctx context.Context, query EventDefinitionListParams, opts ...option.RequestOption) (res *pagination.Page[ExternalBehavioralEventTypeDefinition], err error) {
...
// Retrieve existing custom event definitions.
func (r *EventDefinitionService) ListAutoPaging(ctx context.Context, query EventDefinitionListParams, opts ...option.RequestOption) *pagination.PageAutoPager[ExternalBehavioralEventTypeDefinition] {
...
func (r *EventDefinitionService) NewProperty(ctx context.Context, eventName string, body EventDefinitionNewPropertyParams, opts ...option.RequestOption) (res *shared.Property, err error) {
	opts = slices.Concat(r.Options, opts)
	if eventName == "" {
		err = errors.New("missing required eventName parameter")
		return
	}
	path := fmt.Sprintf("events/v3/event-definitions/%s/property", eventName)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPost, path, body, &res, opts...)
	return
}
...
func (r *EventDefinitionService) DeleteProperty(ctx context.Context, propertyName string, body EventDefinitionDeletePropertyParams, opts ...option.RequestOption) (err error) {
	...
	path := fmt.Sprintf("events/v3/event-definitions/%s/property/%s", body.EventName, propertyName)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodDelete, path, nil, nil, opts...)
	return
}

// Fetch a single custom event definition by name.
func (r *EventDefinitionService) Get(ctx context.Context, eventName string, opts ...option.RequestOption) (res *ExternalBehavioralEventTypeDefinition, err error) {
	opts = slices.Concat(r.Options, opts)
	if eventName == "" {
		err = errors.New("missing required eventName parameter")
		return
...
func (r *EventDefinitionService) UpdateProperty(ctx context.Context, propertyName string, params EventDefinitionUpdatePropertyParams, opts ...option.RequestOption) (res *shared.Property, err error) {
	opts = slices.Concat(r.Options, opts)
	if params.EventName == "" {
		err = errors.New("missing required eventName parameter")
		return
	...
	path := fmt.Sprintf("events/v3/event-definitions/%s/property/%s", params.EventName, propertyName)
...
type AbsoluteComparativeTimestampRefineBy struct {
	// Any of "AFTER", "BEFORE".
	Comparison AbsoluteComparativeTimestampRefineByComparison `json:"comparison,required"`
	Timestamp  int64                                          `json:"timestamp,required"`
	// Any of "AbsoluteComparativeTimestampRefineBy".
	Type AbsoluteComparativeTimestampRefineByType `json:"type,required"`
...
type AbsoluteRangedTimestampRefineBy struct {
	LowerTimestamp int64 `json:"lowerTimestamp,required"`
	// Any of "BETWEEN", "NOT_BETWEEN".
	RangeType AbsoluteRangedTimestampRefineByRangeType `json:"rangeType,required"`
	// Any of "AbsoluteRangedTimestampRefineBy".
	Type           AbsoluteRangedTimestampRefineByType `json:"type,required"`
	UpperTimestamp int64                               `json:"upperTimestamp,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type AllHistoryRefineBy struct {
	...
	Type AllHistoryRefineByType `json:"type,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Type        respjson.Field
		ExtraFields map[string]respjson.Field
...
type AllPropertyTypesOperation struct {
	CoalescingRefineBy           AllPropertyTypesOperationCoalescingRefineByUnion `json:"coalescingRefineBy,required"`
	IncludeObjectsWithNoValueSet bool                                             `json:"includeObjectsWithNoValueSet,required"`
	OperationType                string                                           `json:"operationType,required"`
	// Any of "IS_BLANK", "IS_KNOWN", "IS_NOT_BLANK", "IS_UNKNOWN".
	Operator     AllPropertyTypesOperationOperator `json:"operator,required"`
	OperatorName string                            `json:"operatorName,required"`
	// Any of "alltypes".
	PropertyType    AllPropertyTypesOperationPropertyType         `json:"propertyType,required"`
...
type AssociationDefinition struct {
	...
	Cardinality AssociationDefinitionCardinality `json:"cardinality,required"`
	...
	Category AssociationDefinitionCategory `json:"category,required"`
	...
	//
	// Any of "ONE_TO_MANY", "ONE_TO_ONE".
	InverseCardinality AssociationDefinitionInverseCardinality `json:"inverseCardinality,required"`
...
type BehavioralEventTypeDefinitionLabels struct {
	Singular string `json:"singular,required"`
...
type BoolPropertyOperation struct {
	...
	// "IS_NOT_EQUAL_TO".
	Operator     BoolPropertyOperationOperator `json:"operator,required"`
	OperatorName string                        `json:"operatorName,required"`
	// Any of "bool".
	PropertyType BoolPropertyOperationPropertyType `json:"propertyType,required"`
...
type CalendarDatePropertyOperation struct {
	...
	Operator     CalendarDatePropertyOperationOperator `json:"operator,required"`
	OperatorName string                                `json:"operatorName,required"`
	// Any of "calendar-date".
	PropertyType CalendarDatePropertyOperationPropertyType `json:"propertyType,required"`
	// Any of "DAY", "MONTH", "QUARTER", "WEEK", "YEAR".
	TimeUnit      CalendarDatePropertyOperationTimeUnit `json:"timeUnit,required"`
	TimeUnitCount int64                                 `json:"timeUnitCount,required"`
	UseFiscalYear bool                                  `json:"useFiscalYear,required"`
	DefaultValue  string                                `json:"defaultValue"`
...
type CollectionResponseWithTotalExternalBehavioralEventTypeDefinitionForwardPaging struct {
	Results []ExternalBehavioralEventTypeDefinition `json:"results,required"`
...
// Returns the unmodified JSON received from the API
func (r CollectionResponseWithTotalExternalBehavioralEventTypeDefinitionForwardPaging) RawJSON() string {
	return r.JSON.raw
}
func (r *CollectionResponseWithTotalExternalBehavioralEventTypeDefinitionForwardPaging) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type ComboEventRule struct {
	...
	PropertyFilters    []PropertyFilter `json:"propertyFilters,required"`
...
type ComboEventRuleBranch struct {
	ComposingRules []ComboEventRule `json:"composingRules,required"`
	// Any of "AND", "OR".
	OperationType ComboEventRuleBranchOperationType `json:"operationType,required"`
	RuleBranches  []ComboEventRuleBranch            `json:"ruleBranches,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type ComparativeDatePropertyOperation struct {
	ComparisonPropertyName       string `json:"comparisonPropertyName,required"`
	IncludeObjectsWithNoValueSet bool   `json:"includeObjectsWithNoValueSet,required"`
	OperationType                string `json:"operationType,required"`
	// Any of "IS_AFTER", "IS_BEFORE".
	Operator     ComparativeDatePropertyOperationOperator `json:"operator,required"`
	OperatorName string                                   `json:"operatorName,required"`
	// Any of "datetime-comparative".
	PropertyType           ComparativeDatePropertyOperationPropertyType `json:"propertyType,required"`
...
type ComparativePropertyUpdatedOperation struct {
	...
	OperationType                string `json:"operationType,required"`
	// Any of "IS_AFTER", "IS_BEFORE".
	Operator     ComparativePropertyUpdatedOperationOperator `json:"operator,required"`
	OperatorName string                                      `json:"operatorName,required"`
	// Any of "property-updated-comparative".
	PropertyType           ComparativePropertyUpdatedOperationPropertyType `json:"propertyType,required"`
	DefaultComparisonValue string                                          `json:"defaultComparisonValue"`
	DefaultValue           string                                          `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type DatePoint struct {
	...
	// Any of "DATE".
	TimeType DatePointTimeType `json:"timeType,required"`
	// Any of "CUSTOM", "PORTAL", "USER".
	TimezoneSource DatePointTimezoneSource `json:"timezoneSource,required"`
...
type DatePropertyOperation struct {
	...
	// "OCT", "SEP".
	Month         DatePropertyOperationMonth `json:"month,required"`
	OperationType string                     `json:"operationType,required"`
	// Any of "AFTER", "BEFORE", "EQUAL".
	Operator     DatePropertyOperationOperator `json:"operator,required"`
	OperatorName string                        `json:"operatorName,required"`
	// Any of "date".
	PropertyType DatePropertyOperationPropertyType `json:"propertyType,required"`
	Year         int64                             `json:"year,required"`
	DefaultValue string                            `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type DateTimePropertyOperation struct {
	...
	// "IS_EQUAL_TO".
	Operator     DateTimePropertyOperationOperator `json:"operator,required"`
	OperatorName string                            `json:"operatorName,required"`
	// Any of "datetime".
	PropertyType               DateTimePropertyOperationPropertyType `json:"propertyType,required"`
	RequiresTimeZoneConversion bool                                  `json:"requiresTimeZoneConversion,required"`
	Timestamp                  int64                                 `json:"timestamp,required"`
	DefaultValue               string                                `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type EnumerationPropertyOperation struct {
	...
	Operator     EnumerationPropertyOperationOperator `json:"operator,required"`
	OperatorName string                               `json:"operatorName,required"`
	// Any of "enumeration".
	PropertyType EnumerationPropertyOperationPropertyType `json:"propertyType,required"`
...
type ExternalBehavioralEventTypeDefinition struct {
	...
	Associations       []AssociationDefinition             `json:"associations,required"`
	FullyQualifiedName string                              `json:"fullyQualifiedName,required"`
	Labels             BehavioralEventTypeDefinitionLabels `json:"labels,required"`
	Name               string                              `json:"name,required"`
	...
	// Any of "CLICKED_ELEMENT", "COMBO_EVENT", "CUSTOM_SCRIPT", "IMPORT", "MANUAL",
	// "PROPERTY_CHANGE", "VISITED_URL", "WEBHOOK".
...
// The properties Label, PropertyDefinitions are required.
type ExternalBehavioralEventTypeDefinitionEggParam struct {
	...
	PropertyDefinitions []ExternalBehavioralEventPropertyCreateParam `json:"propertyDefinitions,omitzero,required"`
...
type FiscalQuarter struct {
	...
	ReferenceType FiscalQuarterReferenceType `json:"referenceType,required"`
	Hour          int64                      `json:"hour"`
	Millisecond   int64                      `json:"millisecond"`
	Minute        int64                      `json:"minute"`
	Second        int64                      `json:"second"`
...
type FiscalYear struct {
	...
	Month int64 `json:"month,required"`
	// Any of "FISCAL_YEAR".
	ReferenceType FiscalYearReferenceType `json:"referenceType,required"`
	Hour          int64                   `json:"hour"`
	Millisecond   int64                   `json:"millisecond"`
	Minute        int64                   `json:"minute"`
	Second        int64                   `json:"second"`
...
type IndexedTimePoint struct {
	IndexReference IndexedTimePointIndexReferenceUnion `json:"indexReference,required"`
	// Any of "INDEXED".
	TimeType IndexedTimePointTimeType `json:"timeType,required"`
	// Any of "CUSTOM", "PORTAL", "USER".
	TimezoneSource IndexedTimePointTimezoneSource `json:"timezoneSource,required"`
	ZoneID         string                         `json:"zoneId,required"`
...
type MonthReference struct {
	Day int64 `json:"day,required"`
	// Any of "MONTH".
	ReferenceType MonthReferenceReferenceType `json:"referenceType,required"`
	Hour          int64                       `json:"hour"`
	Millisecond   int64                       `json:"millisecond"`
	Minute        int64                       `json:"minute"`
	Second        int64                       `json:"second"`
...
type MultiStringPropertyOperation struct {
	CoalescingRefineBy           MultiStringPropertyOperationCoalescingRefineByUnion `json:"coalescingRefineBy,required"`
	IncludeObjectsWithNoValueSet bool                                                `json:"includeObjectsWithNoValueSet,required"`
	OperationType                string                                              `json:"operationType,required"`
	// Any of "CONTAINS", "DOES_NOT_CONTAIN", "ENDS_WITH", "IS_EQUAL_TO",
	// "IS_NOT_EQUAL_TO", "STARTS_WITH".
	Operator     MultiStringPropertyOperationOperator `json:"operator,required"`
	OperatorName string                               `json:"operatorName,required"`
	// Any of "multistring".
	PropertyType    MultiStringPropertyOperationPropertyType         `json:"propertyType,required"`
	Values          []string                                         `json:"values,required"`
	DefaultValue    string                                           `json:"defaultValue"`
...
type NowReference struct {
	// Any of "NOW".
	ReferenceType NowReferenceReferenceType `json:"referenceType,required"`
	Hour          int64                     `json:"hour"`
	Millisecond   int64                     `json:"millisecond"`
	Minute        int64                     `json:"minute"`
	Second        int64                     `json:"second"`
...
type NumOccurrencesRefineBy struct {
	...
	Type           NumOccurrencesRefineByType `json:"type,required"`
	MaxOccurrences int64                      `json:"maxOccurrences"`
	MinOccurrences int64                      `json:"minOccurrences"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type NumberPropertyOperation struct {
	...
	Operator     NumberPropertyOperationOperator `json:"operator,required"`
	OperatorName string                          `json:"operatorName,required"`
	// Any of "number".
	PropertyType NumberPropertyOperationPropertyType `json:"propertyType,required"`
...
type PropertyFilter struct {
	// Any of "PROPERTY".
	FilterType        PropertyFilterFilterType     `json:"filterType,required"`
	Operation         PropertyFilterOperationUnion `json:"operation,required"`
...
// [RollingDateRangePropertyOperation], [RollingPropertyUpdatedOperation],
// [EnumerationPropertyOperation], [AllPropertyTypesOperation],
// [RangedNumberPropertyOperation], [MultiStringPropertyOperation],
// [DatePropertyOperation], [CalendarDatePropertyOperation], [TimePointOperation],
// [RangedTimeOperation].
//
// Use the methods beginning with 'As' to cast the union to one of its variants.
...
type PropertyReferencedTime struct {
	...
	ReferenceType PropertyReferencedTimeReferenceType `json:"referenceType,required"`
	// Any of "PROPERTY_REFERENCED".
	TimeType PropertyReferencedTimeTimeType `json:"timeType,required"`
	// Any of "CUSTOM", "PORTAL", "USER".
	TimezoneSource PropertyReferencedTimeTimezoneSource `json:"timezoneSource,required"`
	ZoneID         string                               `json:"zoneId,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Property       respjson.Field
...
type QuarterReference struct {
	...
	Month int64 `json:"month,required"`
	// Any of "QUARTER".
	ReferenceType QuarterReferenceReferenceType `json:"referenceType,required"`
	Hour          int64                         `json:"hour"`
	Millisecond   int64                         `json:"millisecond"`
	Minute        int64                         `json:"minute"`
	Second        int64                         `json:"second"`
...
type RangedDatePropertyOperation struct {
	IncludeObjectsWithNoValueSet bool   `json:"includeObjectsWithNoValueSet,required"`
	LowerBoundTimestamp          int64  `json:"lowerBoundTimestamp,required"`
	OperationType                string `json:"operationType,required"`
	// Any of "IS_BETWEEN", "IS_NOT_BETWEEN".
	Operator     RangedDatePropertyOperationOperator `json:"operator,required"`
	OperatorName string                              `json:"operatorName,required"`
	// Any of "datetime-ranged".
	PropertyType               RangedDatePropertyOperationPropertyType `json:"propertyType,required"`
	RequiresTimeZoneConversion bool                                    `json:"requiresTimeZoneConversion,required"`
	UpperBoundTimestamp        int64                                   `json:"upperBoundTimestamp,required"`
	DefaultValue               string                                  `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		IncludeObjectsWithNoValueSet respjson.Field
...
type RangedNumberPropertyOperation struct {
	IncludeObjectsWithNoValueSet bool   `json:"includeObjectsWithNoValueSet,required"`
	LowerBound                   int64  `json:"lowerBound,required"`
	OperationType                string `json:"operationType,required"`
	// Any of "IS_BETWEEN", "IS_NOT_BETWEEN".
	Operator     RangedNumberPropertyOperationOperator `json:"operator,required"`
	OperatorName string                                `json:"operatorName,required"`
	// Any of "number-ranged".
	PropertyType RangedNumberPropertyOperationPropertyType `json:"propertyType,required"`
	UpperBound   int64                                     `json:"upperBound,required"`
	DefaultValue string                                    `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		IncludeObjectsWithNoValueSet respjson.Field
...
type RangedTimeOperation struct {
	...
	LowerBoundEndpointBehavior RangedTimeOperationLowerBoundEndpointBehavior `json:"lowerBoundEndpointBehavior,required"`
	LowerBoundTimePoint        RangedTimeOperationLowerBoundTimePointUnion   `json:"lowerBoundTimePoint,required"`
	OperationType              string                                        `json:"operationType,required"`
	// Any of "IS_BETWEEN", "IS_NOT_BETWEEN".
	Operator     RangedTimeOperationOperator `json:"operator,required"`
	OperatorName string                      `json:"operatorName,required"`
	// Any of "ANNIVERSARY", "ANNIVERSARY_WITH_ZONE_SAME_LOCAL_CONVERSION",
	// "UPDATED_AT", "VALUE", "VALUE_WITH_ZONE_SAME_LOCAL_CONVERSION".
	PropertyParser RangedTimeOperationPropertyParser `json:"propertyParser,required"`
	// Any of "rangedtime".
	PropertyType RangedTimeOperationPropertyType `json:"propertyType,required"`
	Type         string                          `json:"type,required"`
	// Any of "EXCLUSIVE", "INCLUSIVE".
	UpperBoundEndpointBehavior RangedTimeOperationUpperBoundEndpointBehavior `json:"upperBoundEndpointBehavior,required"`
	UpperBoundTimePoint        RangedTimeOperationUpperBoundTimePointUnion   `json:"upperBoundTimePoint,required"`
	DefaultValue               string                                        `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		IncludeObjectsWithNoValueSet respjson.Field
...
type RelativeComparativeTimestampRefineBy struct {
	// Any of "AFTER", "BEFORE".
	Comparison RelativeComparativeTimestampRefineByComparison `json:"comparison,required"`
	TimeOffset TimeOffset                                     `json:"timeOffset,required"`
	// Any of "RelativeComparativeTimestampRefineBy".
	Type RelativeComparativeTimestampRefineByType `json:"type,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Comparison  respjson.Field
		TimeOffset  respjson.Field
...
type RelativeRangedTimestampRefineBy struct {
	LowerBoundOffset TimeOffset `json:"lowerBoundOffset,required"`
	// Any of "BETWEEN", "NOT_BETWEEN".
	RangeType RelativeRangedTimestampRefineByRangeType `json:"rangeType,required"`
	// Any of "RelativeRangedTimestampRefineBy".
	Type             RelativeRangedTimestampRefineByType `json:"type,required"`
	UpperBoundOffset TimeOffset                          `json:"upperBoundOffset,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		LowerBoundOffset respjson.Field
		RangeType        respjson.Field
...
type RollingDateRangePropertyOperation struct {
	IncludeObjectsWithNoValueSet bool   `json:"includeObjectsWithNoValueSet,required"`
	NumberOfDays                 int64  `json:"numberOfDays,required"`
	OperationType                string `json:"operationType,required"`
	// Any of "IS_LESS_THAN_X_DAYS_AGO", "IS_LESS_THAN_X_DAYS_FROM_NOW",
	// "IS_MORE_THAN_X_DAYS_AGO", "IS_MORE_THAN_X_DAYS_FROM_NOW".
	Operator     RollingDateRangePropertyOperationOperator `json:"operator,required"`
	OperatorName string                                    `json:"operatorName,required"`
	// Any of "datetime-rolling".
	PropertyType               RollingDateRangePropertyOperationPropertyType `json:"propertyType,required"`
	RequiresTimeZoneConversion bool                                          `json:"requiresTimeZoneConversion,required"`
	DefaultValue               string                                        `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type RollingPropertyUpdatedOperation struct {
	...
	Operator     RollingPropertyUpdatedOperationOperator `json:"operator,required"`
	OperatorName string                                  `json:"operatorName,required"`
	// Any of "rolling-property-updated".
	PropertyType RollingPropertyUpdatedOperationPropertyType `json:"propertyType,required"`
	DefaultValue string                                      `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		IncludeObjectsWithNoValueSet respjson.Field
...
type SetOccurrencesRefineBy struct {
	...
	// "NONE_EXCLUDE_EMPTY".
	SetType SetOccurrencesRefineBySetType `json:"setType,required"`
	// Any of "SetOccurrencesRefineBy".
	Type SetOccurrencesRefineByType `json:"type,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		SetType     respjson.Field
		Type        respjson.Field
...
type StringPropertyOperation struct {
	...
	Operator     StringPropertyOperationOperator `json:"operator,required"`
	OperatorName string                          `json:"operatorName,required"`
	// Any of "string".
	PropertyType StringPropertyOperationPropertyType `json:"propertyType,required"`
...
type TimeOffset struct {
	...
	// Any of "FUTURE", "PAST".
	OffsetDirection TimeOffsetOffsetDirection `json:"offsetDirection,required"`
	// Any of "DAYS", "HOURS", "MINUTES", "WEEKS".
	TimeUnit TimeOffsetTimeUnit `json:"timeUnit,required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type TimePointOperation struct {
	// Any of "EXCLUSIVE", "INCLUSIVE".
	EndpointBehavior             TimePointOperationEndpointBehavior `json:"endpointBehavior,required"`
	IncludeObjectsWithNoValueSet bool                               `json:"includeObjectsWithNoValueSet,required"`
	OperationType                string                             `json:"operationType,required"`
	// Any of "IS_AFTER", "IS_BEFORE".
	Operator     TimePointOperationOperator `json:"operator,required"`
	OperatorName string                     `json:"operatorName,required"`
	// Any of "ANNIVERSARY", "ANNIVERSARY_WITH_ZONE_SAME_LOCAL_CONVERSION",
	// "UPDATED_AT", "VALUE", "VALUE_WITH_ZONE_SAME_LOCAL_CONVERSION".
	PropertyParser TimePointOperationPropertyParser `json:"propertyParser,required"`
	// Any of "timepoint".
	PropertyType TimePointOperationPropertyType   `json:"propertyType,required"`
	TimePoint    TimePointOperationTimePointUnion `json:"timePoint,required"`
	Type         string                           `json:"type,required"`
	DefaultValue string                           `json:"defaultValue"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type TodayReference struct {
	// Any of "TODAY".
	ReferenceType TodayReferenceReferenceType `json:"referenceType,required"`
	Hour          int64                       `json:"hour"`
	Millisecond   int64                       `json:"millisecond"`
	Minute        int64                       `json:"minute"`
	Second        int64                       `json:"second"`
...
type WeekReference struct {
	...
	// "WEDNESDAY".
	DayOfWeek WeekReferenceDayOfWeek `json:"dayOfWeek,required"`
	// Any of "WEEK".
	ReferenceType WeekReferenceReferenceType `json:"referenceType,required"`
	Hour          int64                      `json:"hour"`
	Millisecond   int64                      `json:"millisecond"`
	Minute        int64                      `json:"minute"`
	Second        int64                      `json:"second"`
...
type YearReference struct {
	...
	Month int64 `json:"month,required"`
	// Any of "YEAR".
	ReferenceType YearReferenceReferenceType `json:"referenceType,required"`
	Hour          int64                      `json:"hour"`
	Millisecond   int64                      `json:"millisecond"`
	Minute        int64                      `json:"minute"`
	Second        int64                      `json:"second"`
...
// URLQuery serializes [EventDefinitionListParams]'s query parameters as
// `url.Values`.
func (r EventDefinitionListParams) URLQuery() (v url.Values, err error) {
...
type EventDefinitionNewPropertyParams struct {
	ExternalBehavioralEventPropertyCreate ExternalBehavioralEventPropertyCreateParam
	paramObj
}

func (r EventDefinitionNewPropertyParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.ExternalBehavioralEventPropertyCreate)
}
func (r *EventDefinitionNewPropertyParams) UnmarshalJSON(data []byte) error {
	return json.Unmarshal(data, &r.ExternalBehavioralEventPropertyCreate)
}

type EventDefinitionDeletePropertyParams struct {
	EventName string `path:"eventName,required" json:"-"`
	paramObj
}

type EventDefinitionUpdatePropertyParams struct {
	EventName                                      string `path:"eventName,required" json:"-"`
	ExternalBehavioralEventPropertyDefinitionPatch ExternalBehavioralEventPropertyDefinitionPatchParam
	paramObj
}

func (r EventDefinitionUpdatePropertyParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.ExternalBehavioralEventPropertyDefinitionPatch)
}
func (r *EventDefinitionUpdatePropertyParams) UnmarshalJSON(data []byte) error {
