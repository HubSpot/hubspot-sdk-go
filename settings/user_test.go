...
func TestUserNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settings.Users.New(context.TODO(), settings.UserNewParams{
		UserProvisionRequest: settings.UserProvisionRequestParam{
			...
			PrimaryTeamID:    hubspotsdk.String("primaryTeamId"),
			RoleID:           hubspotsdk.String("roleId"),
			SecondaryTeamIDs: []string{"string"},
		},
	})
	if err != nil {
...
func TestUserUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settings.Users.Update(
		context.TODO(),
		"userId",
...
func TestUserListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settings.Users.List(context.TODO(), settings.UserListParams{
...
func TestUserGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Settings.Users.Get(
		context.TODO(),
		"userId",
...
func TestUserListRoles(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Settings.Users.ListRoles(context.TODO())
	if err != nil {
		var apierr *hubspotsdk.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestUserListTeams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Settings.Users.ListTeams(context.TODO())
	if err != nil {
		var apierr *hubspotsdk.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
