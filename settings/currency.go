...
type BatchInputExchangeRateCreateRequestParam struct {
	Inputs []ExchangeRateCreateRequestParam `json:"inputs,omitzero" api:"required"`
	paramObj
}
...
type BatchInputExchangeRateUpdateRequestParam struct {
	Inputs []ExchangeRateUpdateRequestParam `json:"inputs,omitzero" api:"required"`
	paramObj
}
...
type BatchResponseExchangeRate struct {
	...
	Results     []ExchangeRate `json:"results" api:"required"`
...
type CentralExchangeRatesInformation struct {
	...
	CentralExchangeRatesEnabled bool `json:"centralExchangeRatesEnabled" api:"required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type CollectionResponseCurrencyCodeInfoNoPaging struct {
	Results []CurrencyCodeInfo `json:"results" api:"required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Results     respjson.Field
		ExtraFields map[string]respjson.Field
...
type CompanyCurrencyUpdateRequestParam struct {
	...
	// "ZWL".
	CurrencyCode CompanyCurrencyUpdateRequestCurrencyCode `json:"currencyCode,omitzero" api:"required"`
	paramObj
}
...
type CurrencyCodeInfo struct {
	...
	CurrencyName string `json:"currencyName" api:"required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
type CurrencyCreateRequestParam struct {
	...
	// "XCD", "XDR", "XOF", "XPD", "XPF", "XPT", "XSU", "XUA", "YER", "ZAR", "ZMW",
	// "ZWL".
	CurrencyCode CurrencyCreateRequestCurrencyCode `json:"currencyCode,omitzero" api:"required"`
	paramObj
}
...
type CurrencyPairUpdateParam struct {
	...
	// "XCD", "XDR", "XOF", "XPD", "XPF", "XPT", "XSU", "XUA", "YER", "ZAR", "ZMW",
	// "ZWL".
	FromCurrencyCode CurrencyPairUpdateFromCurrencyCode `json:"fromCurrencyCode,omitzero" api:"required"`
	// This represents the three-letter currency code (such as USD for US Dollar) of
	...
	// "XCD", "XDR", "XOF", "XPD", "XPF", "XPT", "XSU", "XUA", "YER", "ZAR", "ZMW",
	// "ZWL".
	ToCurrencyCode CurrencyPairUpdateToCurrencyCode `json:"toCurrencyCode,omitzero" api:"required"`
	...
	VisibleInUi bool `json:"visibleInUI" api:"required"`
	paramObj
}
...
type ExchangeRate struct {
	...
	// "XCD", "XDR", "XOF", "XPD", "XPF", "XPT", "XSU", "XUA", "YER", "ZAR", "ZMW",
	// "ZWL".
	FromCurrencyCode ExchangeRateFromCurrencyCode `json:"fromCurrencyCode" api:"required"`
	// This represents the three-letter currency code (such as USD for US Dollar) of
	...
	// "XCD", "XDR", "XOF", "XPD", "XPF", "XPT", "XSU", "XUA", "YER", "ZAR", "ZMW",
	// "ZWL".
	ToCurrencyCode ExchangeRateToCurrencyCode `json:"toCurrencyCode" api:"required"`
...
type ExchangeRateCreateRequestParam struct {
	...
	// "XCD", "XDR", "XOF", "XPD", "XPF", "XPT", "XSU", "XUA", "YER", "ZAR", "ZMW",
	// "ZWL".
	FromCurrencyCode ExchangeRateCreateRequestFromCurrencyCode `json:"fromCurrencyCode,omitzero" api:"required"`
	// The date the exchange rate is in effect.
