...
func TestSubscriptionNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Webhooks.Subscriptions.New(
		context.TODO(),
		0,
		webhooks.SubscriptionNewParams{
			SubscriptionCreateRequest: webhooks.SubscriptionCreateRequestParam{
				EventType:    webhooks.SubscriptionCreateRequestEventTypeContactPropertyChange,
				Active:       hubspotsdk.Bool(true),
				ObjectTypeID: hubspotsdk.String("objectTypeId"),
				PropertyName: hubspotsdk.String("email"),
			},
		},
	)
	if err != nil {
...
func TestSubscriptionUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Webhooks.Subscriptions.Update(
		context.TODO(),
		0,
		webhooks.SubscriptionUpdateParams{
			AppID: 0,
...
func TestSubscriptionList(t *testing.T) {
	...
	_, err := client.Webhooks.Subscriptions.List(context.TODO(), 0)
	if err != nil {
		var apierr *hubspotsdk.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestSubscriptionDelete(t *testing.T) {
	...
	err := client.Webhooks.Subscriptions.Delete(
		context.TODO(),
		0,
		webhooks.SubscriptionDeleteParams{
			AppID: 0,
		},
	)
	if err != nil {
...
func TestSubscriptionGet(t *testing.T) {
	...
	_, err := client.Webhooks.Subscriptions.Get(
		context.TODO(),
		0,
		webhooks.SubscriptionGetParams{
			AppID: 0,
		},
	)
	if err != nil {
...
func TestSubscriptionUpdateBatch(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Webhooks.Subscriptions.UpdateBatch(
		context.TODO(),
		0,
		webhooks.SubscriptionUpdateBatchParams{
