...
func TestSettingUpdate(t *testing.T) {
	...
	_, err := client.Webhooks.Settings.Update(
		context.TODO(),
		0,
		webhooks.SettingUpdateParams{
...
func TestSettingList(t *testing.T) {
	...
	_, err := client.Webhooks.Settings.List(context.TODO(), 0)
	if err != nil {
		var apierr *hubspotsdk.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestSettingDelete(t *testing.T) {
	...
	err := client.Webhooks.Settings.Delete(context.TODO(), 0)
	if err != nil {
		var apierr *hubspotsdk.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
