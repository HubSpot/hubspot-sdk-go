...
- <code title="post /oauth/2026-03/token">client.Auth.OAuth.<a href="https://pkg.go.dev/github.com/HubSpot/hubspot-sdk-go/auth#OAuthService.NewToken">NewToken</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, body <a href="https://pkg.go.dev/github.com/HubSpot/hubspot-sdk-go/auth">auth</a>.<a href="https://pkg.go.dev/github.com/HubSpot/hubspot-sdk-go/auth#OAuthNewTokenParams">OAuthNewTokenParams</a>) (\*http.Response, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
