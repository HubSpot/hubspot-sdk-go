...
// provided.
func (r *ObjectDiscountService) New(ctx context.Context, body ObjectDiscountNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectDiscountService) Update(ctx context.Context, discountID string, params ObjectDiscountUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/discounts/%s", url.PathEscape(discountID))
