...
// provided.
func (r *ObjectOrderService) New(ctx context.Context, body ObjectOrderNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectOrderService) Update(ctx context.Context, orderID string, params ObjectOrderUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/orders/%s", url.PathEscape(orderID))
