...
func TestObjectGenericObjectBatchNew(t *testing.T) {
	...
	_, err := client.Crm.Objects.GenericObjects.Batch.New(
		context.TODO(),
		"objectType",
...
func TestObjectGenericObjectBatchUpdate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.GenericObjects.Batch.Update(
		context.TODO(),
		"objectType",
...
func TestObjectGenericObjectBatchDelete(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestObjectGenericObjectBatchGetWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.GenericObjects.Batch.Get(
		context.TODO(),
		"objectType",
...
func TestObjectGenericObjectBatchUpsert(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.GenericObjects.Batch.Upsert(
		context.TODO(),
		"objectType",
