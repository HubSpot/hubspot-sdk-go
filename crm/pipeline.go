...
func (r *PipelineService) New(ctx context.Context, objectType string, body PipelineNewParams, opts ...option.RequestOption) (res *Pipeline, err error) {
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s", url.PathEscape(objectType))
...
func (r *PipelineService) Update(ctx context.Context, pipelineID string, params PipelineUpdateParams, opts ...option.RequestOption) (res *Pipeline, err error) {
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s", url.PathEscape(params.ObjectType), url.PathEscape(pipelineID))
...
func (r *PipelineService) NewStage(ctx context.Context, pipelineID string, params PipelineNewStageParams, opts ...option.RequestOption) (res *PipelineStage, err error) {
	opts = slices.Concat(r.options, opts)
	if params.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
		return nil, err
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s/stages", url.PathEscape(params.ObjectType), url.PathEscape(pipelineID))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPost, path, params, &res, opts...)
	return res, err
}

// Delete a pipeline stage
func (r *PipelineService) DeleteStage(ctx context.Context, stageID string, body PipelineDeleteStageParams, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.options, opts)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "*/*")}, opts...)
	if body.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s/stages/%s", url.PathEscape(body.ObjectType), url.PathEscape(body.PipelineID), url.PathEscape(stageID))
...
func (r *PipelineService) Get(ctx context.Context, pipelineID string, query PipelineGetParams, opts ...option.RequestOption) (res *Pipeline, err error) {
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s", url.PathEscape(query.ObjectType), url.PathEscape(pipelineID))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return res, err
}

// Return a pipeline stage by ID
func (r *PipelineService) GetStage(ctx context.Context, stageID string, query PipelineGetStageParams, opts ...option.RequestOption) (res *PipelineStage, err error) {
	opts = slices.Concat(r.options, opts)
	if query.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
		return nil, err
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s/stages/%s", url.PathEscape(query.ObjectType), url.PathEscape(query.PipelineID), url.PathEscape(stageID))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return res, err
}
...
func (r *PipelineService) ListAudit(ctx context.Context, pipelineID string, query PipelineListAuditParams, opts ...option.RequestOption) (res *CollectionResponsePublicAuditInfoNoPaging, err error) {
	opts = slices.Concat(r.options, opts)
	if query.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
		return nil, err
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s/audit", url.PathEscape(query.ObjectType), url.PathEscape(pipelineID))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return res, err
}
...
func (r *PipelineService) ListStageAudit(ctx context.Context, stageID string, query PipelineListStageAuditParams, opts ...option.RequestOption) (res *CollectionResponsePublicAuditInfoNoPaging, err error) {
	opts = slices.Concat(r.options, opts)
	if query.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
		return nil, err
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s/stages/%s/audit", url.PathEscape(query.ObjectType), url.PathEscape(query.PipelineID), url.PathEscape(stageID))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return res, err
}

// Return all the stages associated with the pipeline identified by `{pipelineId}`.
func (r *PipelineService) ListStages(ctx context.Context, pipelineID string, query PipelineListStagesParams, opts ...option.RequestOption) (res *CollectionResponsePipelineStageNoPaging, err error) {
	opts = slices.Concat(r.options, opts)
	if query.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
		return nil, err
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s/stages", url.PathEscape(query.ObjectType), url.PathEscape(pipelineID))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return res, err
}

// Replace a pipeline
func (r *PipelineService) UpdateAllProperties(ctx context.Context, pipelineID string, params PipelineUpdateAllPropertiesParams, opts ...option.RequestOption) (res *Pipeline, err error) {
	opts = slices.Concat(r.options, opts)
	if params.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
		return nil, err
...
func (r *PipelineService) UpdateStage(ctx context.Context, stageID string, params PipelineUpdateStageParams, opts ...option.RequestOption) (res *PipelineStage, err error) {
	opts = slices.Concat(r.options, opts)
	if params.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
		return nil, err
	...
	path := fmt.Sprintf("crm/pipelines/2026-03/%s/%s/stages/%s", url.PathEscape(params.ObjectType), url.PathEscape(params.PipelineID), url.PathEscape(stageID))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPatch, path, params, &res, opts...)
	return res, err
}
...
func (r *PipelineService) UpdateStageAllProperties(ctx context.Context, stageID string, params PipelineUpdateStageAllPropertiesParams, opts ...option.RequestOption) (res *PipelineStage, err error) {
	opts = slices.Concat(r.options, opts)
	if params.ObjectType == "" {
		err = errors.New("missing required objectType parameter")
		return nil, err
...
type CollectionResponsePipelineNoPaging struct {
	Results []Pipeline `json:"results" api:"required"`
...
type CollectionResponsePipelineStageNoPaging struct {
	Results []PipelineStage `json:"results" api:"required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Results     respjson.Field
		ExtraFields map[string]respjson.Field
...
type CollectionResponsePublicAuditInfoNoPaging struct {
	Results []PublicAuditInfo `json:"results" api:"required"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Results     respjson.Field
		ExtraFields map[string]respjson.Field
...
type Pipeline struct {
	...
	Stages []PipelineStage `json:"stages" api:"required"`
...
type PipelineInputParam struct {
	...
	Stages     []PipelineStageInputParam `json:"stages,omitzero" api:"required"`
	PipelineID param.Opt[string]         `json:"pipelineId,omitzero"`
	paramObj
}
...
// The properties DisplayOrder, Label, Stages are required.
type PipelineReplaceInputParam struct {
...
func (r PipelineReplaceInputParam) MarshalJSON() (data []byte, err error) {
	type shadow PipelineReplaceInputParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *PipelineReplaceInputParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type PipelineStage struct {
	...
	WritePermissions PipelineStageWritePermissions `json:"writePermissions" api:"required"`
	// The date the pipeline was archived. `archivedAt` will only be present if the
	// pipeline is archived.
	ArchivedAt time.Time `json:"archivedAt" format:"date-time"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
...
type PipelineStageInputParam struct {
	...
	StageID  param.Opt[string] `json:"stageId,omitzero"`
	paramObj
}
...
// The properties DisplayOrder, Label, Metadata are required.
type PipelineStageReplaceInputParam struct {
	// The order for displaying this pipeline stage. If two pipeline stages have a
	// matching `displayOrder`, they will be sorted alphabetically by label.
	DisplayOrder int64 `json:"displayOrder" api:"required"`
	// A label used to organize pipeline stages in HubSpot's UI. Each pipeline stage's
...
func (r PipelineStageReplaceInputParam) MarshalJSON() (data []byte, err error) {
	type shadow PipelineStageReplaceInputParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *PipelineStageReplaceInputParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type PipelineNewStageParams struct {
	ObjectType         string `path:"objectType" api:"required" json:"-"`
	PipelineStageInput PipelineStageInputParam
	paramObj
}

func (r PipelineNewStageParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.PipelineStageInput)
}
func (r *PipelineNewStageParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type PipelineDeleteStageParams struct {
	ObjectType string `path:"objectType" api:"required" json:"-"`
	PipelineID string `path:"pipelineId" api:"required" json:"-"`
	paramObj
}
...
type PipelineGetStageParams struct {
	ObjectType string `path:"objectType" api:"required" json:"-"`
	PipelineID string `path:"pipelineId" api:"required" json:"-"`
	paramObj
}

type PipelineListAuditParams struct {
	ObjectType string `path:"objectType" api:"required" json:"-"`
	paramObj
}

type PipelineListStageAuditParams struct {
	ObjectType string `path:"objectType" api:"required" json:"-"`
	PipelineID string `path:"pipelineId" api:"required" json:"-"`
	paramObj
}

type PipelineListStagesParams struct {
	ObjectType string `path:"objectType" api:"required" json:"-"`
	paramObj
}

type PipelineUpdateAllPropertiesParams struct {
	ObjectType                          string `path:"objectType" api:"required" json:"-"`
	PipelineReplaceInput                PipelineReplaceInputParam
	ValidateDealStageUsagesBeforeDelete param.Opt[bool] `query:"validateDealStageUsagesBeforeDelete,omitzero" json:"-"`
	ValidateReferencesBeforeDelete      param.Opt[bool] `query:"validateReferencesBeforeDelete,omitzero" json:"-"`
	paramObj
}

func (r PipelineUpdateAllPropertiesParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.PipelineReplaceInput)
}
func (r *PipelineUpdateAllPropertiesParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// URLQuery serializes [PipelineUpdateAllPropertiesParams]'s query parameters as
// `url.Values`.
func (r PipelineUpdateAllPropertiesParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type PipelineUpdateStageParams struct {
	ObjectType              string `path:"objectType" api:"required" json:"-"`
	PipelineID              string `path:"pipelineId" api:"required" json:"-"`
...
func (r PipelineUpdateStageParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.PipelineStagePatchInput)
}
func (r *PipelineUpdateStageParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type PipelineUpdateStageAllPropertiesParams struct {
	ObjectType                string `path:"objectType" api:"required" json:"-"`
	PipelineID                string `path:"pipelineId" api:"required" json:"-"`
	PipelineStageReplaceInput PipelineStageReplaceInputParam
	paramObj
}

func (r PipelineUpdateStageAllPropertiesParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.PipelineStageReplaceInput)
}
func (r *PipelineUpdateStageAllPropertiesParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
