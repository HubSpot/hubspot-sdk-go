...
func TestObjectProjectBatchNew(t *testing.T) {
	...
	_, err := client.Crm.Objects.Projects.Batch.New(context.TODO(), crm.ObjectProjectBatchNewParams{
...
func TestObjectProjectBatchUpdate(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Projects.Batch.Update(context.TODO(), crm.ObjectProjectBatchUpdateParams{
...
func TestObjectProjectBatchDelete(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestObjectProjectBatchGetWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Projects.Batch.Get(context.TODO(), crm.ObjectProjectBatchGetParams{
...
func TestObjectProjectBatchUpsert(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Projects.Batch.Upsert(context.TODO(), crm.ObjectProjectBatchUpsertParams{
