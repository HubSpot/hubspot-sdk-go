...
func (r *ObjectCommunicationService) New(ctx context.Context, body ObjectCommunicationNewParams, opts ...option.RequestOption) (res *CreatedResponseSimplePublicObject, err error) {
...
func (r *ObjectCommunicationService) Update(ctx context.Context, communicationID string, params ObjectCommunicationUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/communications/%s", communicationID)
