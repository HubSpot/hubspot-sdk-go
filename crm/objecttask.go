...
// provided.
func (r *ObjectTaskService) New(ctx context.Context, body ObjectTaskNewParams, opts ...option.RequestOption) (res *CreatedResponseSimplePublicObject, err error) {
...
func (r *ObjectTaskService) Update(ctx context.Context, taskID string, params ObjectTaskUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/tasks/%s", taskID)
