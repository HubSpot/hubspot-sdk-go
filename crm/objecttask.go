...
// provided.
func (r *ObjectTaskService) New(ctx context.Context, body ObjectTaskNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectTaskService) Update(ctx context.Context, taskID string, params ObjectTaskUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	opts = slices.Concat(r.options, opts)
	if taskID == "" {
		err = errors.New("missing required taskId parameter")
		return nil, err
	}
	path := fmt.Sprintf("crm/objects/2026-03/tasks/%s", url.PathEscape(taskID))
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPatch, path, params, &res, opts...)
	return res, err
}

// Read a page of tasks. Control what is returned via the `properties` query param.
func (r *ObjectTaskService) List(ctx context.Context, query ObjectTaskListParams, opts ...option.RequestOption) (res *pagination.Page[SimplePublicObjectWithAssociations], err error) {
...
// Read a page of tasks. Control what is returned via the `properties` query param.
func (r *ObjectTaskService) ListAutoPaging(ctx context.Context, query ObjectTaskListParams, opts ...option.RequestOption) *pagination.PageAutoPager[SimplePublicObjectWithAssociations] {
...
// query param.
func (r *ObjectTaskService) Get(ctx context.Context, taskID string, query ObjectTaskGetParams, opts ...option.RequestOption) (res *SimplePublicObjectWithAssociations, err error) {
	opts = slices.Concat(r.options, opts)
	if taskID == "" {
		err = errors.New("missing required taskId parameter")
		return nil, err
...
func (r *ObjectTaskService) Search(ctx context.Context, body ObjectTaskSearchParams, opts ...option.RequestOption) (res *CollectionResponseWithTotalSimplePublicObject, err error) {
	opts = slices.Concat(r.options, opts)
...
type ObjectTaskNewParams struct {
...
func (r ObjectTaskNewParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.SimplePublicObjectInputForCreate)
}
func (r *ObjectTaskNewParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type ObjectTaskUpdateParams struct {
...
func (r ObjectTaskUpdateParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.SimplePublicObjectInput)
}
func (r *ObjectTaskUpdateParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// URLQuery serializes [ObjectTaskUpdateParams]'s query parameters as `url.Values`.
func (r ObjectTaskUpdateParams) URLQuery() (v url.Values, err error) {
...
type ObjectTaskListParams struct {
...
// URLQuery serializes [ObjectTaskListParams]'s query parameters as `url.Values`.
func (r ObjectTaskListParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type ObjectTaskGetParams struct {
	// Whether to return only results that have been archived.
	Archived param.Opt[bool] `query:"archived,omitzero" json:"-"`
	// The name of a property whose values are unique for this object type
	IDProperty param.Opt[string] `query:"idProperty,omitzero" json:"-"`
...
// URLQuery serializes [ObjectTaskGetParams]'s query parameters as `url.Values`.
func (r ObjectTaskGetParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type ObjectTaskSearchParams struct {
	// Describes a search request
	PublicObjectSearchRequest PublicObjectSearchRequestParam
	paramObj
}

func (r ObjectTaskSearchParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.PublicObjectSearchRequest)
}
func (r *ObjectTaskSearchParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
