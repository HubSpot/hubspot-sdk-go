...
// provided.
func (r *ObjectQuoteService) New(ctx context.Context, body ObjectQuoteNewParams, opts ...option.RequestOption) (res *CreatedResponseSimplePublicObject, err error) {
...
func (r *ObjectQuoteService) Update(ctx context.Context, quoteID string, params ObjectQuoteUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/quotes/%s", quoteID)
