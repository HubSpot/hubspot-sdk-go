...
// provided.
func (r *ObjectCartService) New(ctx context.Context, body ObjectCartNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectCartService) Update(ctx context.Context, cartID string, params ObjectCartUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/carts/%s", url.PathEscape(cartID))
