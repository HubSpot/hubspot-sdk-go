...
func TestObjectCourseNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.CRM.Objects.Courses.New(context.TODO(), crm.ObjectCourseNewParams{
...
func TestObjectCourseUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.Courses.Update(
		context.TODO(),
		"courseId",
...
func TestObjectCourseListWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.Courses.List(context.TODO(), crm.ObjectCourseListParams{
...
func TestObjectCourseDelete(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestObjectCourseGetWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.Courses.Get(
		context.TODO(),
		"courseId",
...
func TestObjectCourseSearchWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.Courses.Search(context.TODO(), crm.ObjectCourseSearchParams{
