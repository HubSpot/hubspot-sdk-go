...
func TestObjectCommercePaymentNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.CRM.Objects.CommercePayments.New(context.TODO(), crm.ObjectCommercePaymentNewParams{
...
func TestObjectCommercePaymentUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.CommercePayments.Update(
		context.TODO(),
		"commercePaymentId",
...
func TestObjectCommercePaymentListWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.CommercePayments.List(context.TODO(), crm.ObjectCommercePaymentListParams{
...
func TestObjectCommercePaymentDelete(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestObjectCommercePaymentGetWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.CommercePayments.Get(
		context.TODO(),
		"commercePaymentId",
...
func TestObjectCommercePaymentSearchWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.CommercePayments.Search(context.TODO(), crm.ObjectCommercePaymentSearchParams{
