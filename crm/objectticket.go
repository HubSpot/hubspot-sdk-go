...
// provided.
func (r *ObjectTicketService) New(ctx context.Context, body ObjectTicketNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectTicketService) Update(ctx context.Context, ticketID string, params ObjectTicketUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/tickets/%s", url.PathEscape(ticketID))
