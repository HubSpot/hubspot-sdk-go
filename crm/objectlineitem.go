...
// provided.
func (r *ObjectLineItemService) New(ctx context.Context, body ObjectLineItemNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	opts = slices.Concat(r.options, opts)
	path := "crm/objects/2026-03/line_items"
...
func (r *ObjectLineItemService) Update(ctx context.Context, lineItemID string, params ObjectLineItemUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/line_items/%s", url.PathEscape(lineItemID))
...
// Execute a search for line items based on filters, properties, and sorting
// options provided in the request body. This endpoint allows you to retrieve line
// items that match specific conditions, facilitating targeted data retrieval in
// CRM operations.
func (r *ObjectLineItemService) Search(ctx context.Context, body ObjectLineItemSearchParams, opts ...option.RequestOption) (res *CollectionResponseWithTotalSimplePublicObject, err error) {
	opts = slices.Concat(r.options, opts)
	path := "crm/objects/2026-03/line_items/search"
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPost, path, body, &res, opts...)
	return res, err
}
