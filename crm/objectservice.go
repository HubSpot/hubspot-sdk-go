...
// provided.
func (r *ObjectServiceService) New(ctx context.Context, body ObjectServiceNewParams, opts ...option.RequestOption) (res *CreatedResponseSimplePublicObject, err error) {
...
func (r *ObjectServiceService) Update(ctx context.Context, serviceID string, params ObjectServiceUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/0-162/%s", serviceID)
