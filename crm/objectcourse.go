...
// provided.
func (r *ObjectCourseService) New(ctx context.Context, body ObjectCourseNewParams, opts ...option.RequestOption) (res *CreatedResponseSimplePublicObject, err error) {
...
func (r *ObjectCourseService) Update(ctx context.Context, courseID string, params ObjectCourseUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/0-410/%s", courseID)
...
type ObjectCourseListParams struct {
	...
	// the maximum number of courses that can be read by a single request.
