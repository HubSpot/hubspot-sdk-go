...
// provided.
func (r *ObjectEmailService) New(ctx context.Context, body ObjectEmailNewParams, opts ...option.RequestOption) (res *CreatedResponseSimplePublicObject, err error) {
...
func (r *ObjectEmailService) Update(ctx context.Context, emailID string, params ObjectEmailUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/emails/%s", emailID)
