...
// provided.
func (r *ObjectProductService) New(ctx context.Context, body ObjectProductNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectProductService) Update(ctx context.Context, productID string, params ObjectProductUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/products/%s", url.PathEscape(productID))
