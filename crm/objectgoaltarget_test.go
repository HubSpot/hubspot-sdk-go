...
func TestObjectGoalTargetNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.CRM.Objects.GoalTargets.New(context.TODO(), crm.ObjectGoalTargetNewParams{
...
func TestObjectGoalTargetUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.GoalTargets.Update(
		context.TODO(),
		"goalTargetId",
...
func TestObjectGoalTargetListWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.GoalTargets.List(context.TODO(), crm.ObjectGoalTargetListParams{
...
func TestObjectGoalTargetDelete(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestObjectGoalTargetGetWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.GoalTargets.Get(
		context.TODO(),
		"goalTargetId",
...
func TestObjectGoalTargetSearchWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.GoalTargets.Search(context.TODO(), crm.ObjectGoalTargetSearchParams{
