...
// provided.
func (r *ObjectDealService) New(ctx context.Context, body ObjectDealNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectDealService) Update(ctx context.Context, dealID string, params ObjectDealUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/0-3/%s", url.PathEscape(dealID))
