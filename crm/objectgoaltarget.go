...
// is provided.
func (r *ObjectGoalTargetService) New(ctx context.Context, body ObjectGoalTargetNewParams, opts ...option.RequestOption) (res *CreatedResponseSimplePublicObject, err error) {
...
func (r *ObjectGoalTargetService) Update(ctx context.Context, goalTargetID string, params ObjectGoalTargetUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/goal_targets/%s", goalTargetID)
