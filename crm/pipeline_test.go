		...
		crm.PipelineNewParams{
			PipelineInput: crm.PipelineInputParam{
				...
				Stages: []crm.PipelineStageInputParam{{
					...
					StageID: hubspotsdk.String("stageId"),
				}},
				PipelineID: hubspotsdk.String("pipelineId"),
			},
		},
	)
	if err != nil {
...
func TestPipelineUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Crm.Pipelines.Update(
		...
		crm.PipelineUpdateParams{
			...
			ValidateDealStageUsagesBeforeDelete: hubspotsdk.Bool(true),
			ValidateReferencesBeforeDelete:      hubspotsdk.Bool(true),
		},
	)
	if err != nil {
		var apierr *hubspotsdk.Error
...
func TestPipelineNewStageWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Pipelines.NewStage(
		context.TODO(),
		"pipelineId",
...
func TestPipelineDeleteStage(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestPipelineGetStage(t *testing.T) {
	...
	_, err := client.Crm.Pipelines.GetStage(
		context.TODO(),
		"stageId",
...
func TestPipelineListAudit(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Pipelines.ListAudit(
		context.TODO(),
		"pipelineId",
...
func TestPipelineListStageAudit(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Pipelines.ListStageAudit(
		context.TODO(),
		"stageId",
...
func TestPipelineListStages(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Pipelines.ListStages(
		context.TODO(),
		"pipelineId",
...
func TestPipelineUpdateAllPropertiesWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Pipelines.UpdateAllProperties(
		context.TODO(),
		"pipelineId",
...
func TestPipelineUpdateStageWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Pipelines.UpdateStage(
		context.TODO(),
		"stageId",
...
func TestPipelineUpdateStageAllProperties(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Pipelines.UpdateStageAllProperties(
		context.TODO(),
		"stageId",
