...
// ObjectTaskBatchService contains methods and other services that help with
// interacting with the Hubspot API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewObjectTaskBatchService] method instead.
type ObjectTaskBatchService struct {
	Options []option.RequestOption
}

// NewObjectTaskBatchService generates a new service that applies the given options
// to each request. These options are applied after the parent client's options (if
// there is one), and before any request-specific options.
func NewObjectTaskBatchService(opts ...option.RequestOption) (r ObjectTaskBatchService) {
	r = ObjectTaskBatchService{}
	r.Options = opts
	return
}
...
func (r ObjectTaskBatchGetParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.BatchReadInputSimplePublicObjectID)
}
func (r *ObjectTaskBatchGetParams) UnmarshalJSON(data []byte) error {
	return json.Unmarshal(data, &r.BatchReadInputSimplePublicObjectID)
}

// URLQuery serializes [ObjectTaskBatchGetParams]'s query parameters as
// `url.Values`.
func (r ObjectTaskBatchGetParams) URLQuery() (v url.Values, err error) {
...
type ObjectTaskBatchUpsertParams struct {
	BatchInputSimplePublicObjectBatchInputUpsert BatchInputSimplePublicObjectBatchInputUpsertParam
	paramObj
}

func (r ObjectTaskBatchUpsertParams) MarshalJSON() (data []byte, err error) {
	return shimjson.Marshal(r.BatchInputSimplePublicObjectBatchInputUpsert)
}
func (r *ObjectTaskBatchUpsertParams) UnmarshalJSON(data []byte) error {
