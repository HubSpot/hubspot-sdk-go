...
func TestObjectUserBatchNew(t *testing.T) {
	...
	_, err := client.Crm.Objects.Users.Batch.New(context.TODO(), crm.ObjectUserBatchNewParams{
...
func TestObjectUserBatchUpdate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Users.Batch.Update(context.TODO(), crm.ObjectUserBatchUpdateParams{
...
func TestObjectUserBatchDelete(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestObjectUserBatchGetWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Users.Batch.Get(context.TODO(), crm.ObjectUserBatchGetParams{
...
func TestObjectUserBatchUpsert(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Users.Batch.Upsert(context.TODO(), crm.ObjectUserBatchUpsertParams{
