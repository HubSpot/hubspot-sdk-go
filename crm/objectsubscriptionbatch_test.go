...
func TestObjectSubscriptionBatchNew(t *testing.T) {
	...
	_, err := client.Crm.Objects.Subscriptions.Batch.New(context.TODO(), crm.ObjectSubscriptionBatchNewParams{
...
func TestObjectSubscriptionBatchUpdate(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Subscriptions.Batch.Update(context.TODO(), crm.ObjectSubscriptionBatchUpdateParams{
...
func TestObjectSubscriptionBatchDelete(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestObjectSubscriptionBatchGetWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Subscriptions.Batch.Get(context.TODO(), crm.ObjectSubscriptionBatchGetParams{
...
func TestObjectSubscriptionBatchUpsert(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Objects.Subscriptions.Batch.Upsert(context.TODO(), crm.ObjectSubscriptionBatchUpsertParams{
