...
func TestTimelineNewEventWithOptionalParams(t *testing.T) {
...
func TestTimelineNewProjectType(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Crm.Timeline.NewProjectType(context.TODO(), crm.TimelineNewProjectTypeParams{
