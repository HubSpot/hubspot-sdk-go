...
func TestObjectObjectBatchNew(t *testing.T) {
	...
	_, err := client.CRM.Objects.Objects.Batch.New(
		context.TODO(),
		"objectType",
		crm.ObjectObjectBatchNewParams{
...
func TestObjectObjectBatchUpdate(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.Objects.Batch.Update(
		context.TODO(),
		"objectType",
		crm.ObjectObjectBatchUpdateParams{
...
func TestObjectObjectBatchDelete(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	err := client.CRM.Objects.Objects.Batch.Delete(
		context.TODO(),
		"objectType",
		crm.ObjectObjectBatchDeleteParams{
...
func TestObjectObjectBatchGetWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.Objects.Batch.Get(
		context.TODO(),
		"objectType",
		crm.ObjectObjectBatchGetParams{
...
func TestObjectObjectBatchUpsert(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.CRM.Objects.Objects.Batch.Upsert(
		context.TODO(),
		"objectType",
		crm.ObjectObjectBatchUpsertParams{
