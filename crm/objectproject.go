...
// including the ID.
func (r *ObjectProjectService) New(ctx context.Context, body ObjectProjectNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectProjectService) Update(ctx context.Context, projectID string, params ObjectProjectUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/projects/%s", url.PathEscape(projectID))
