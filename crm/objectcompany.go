...
func (r *ObjectCompanyService) New(ctx context.Context, body ObjectCompanyNewParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
...
func (r *ObjectCompanyService) Update(ctx context.Context, companyID string, params ObjectCompanyUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/objects/2026-03/companies/%s", url.PathEscape(companyID))
