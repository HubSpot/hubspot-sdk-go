...
func (r *ObjectCommercePaymentService) New(ctx context.Context, body ObjectCommercePaymentNewParams, opts ...option.RequestOption) (res *CreatedResponseSimplePublicObject, err error) {
...
func (r *ObjectCommercePaymentService) Update(ctx context.Context, commercePaymentID string, params ObjectCommercePaymentUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/commerce_payments/%s", commercePaymentID)
