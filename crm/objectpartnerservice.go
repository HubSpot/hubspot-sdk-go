...
type ObjectPartnerServiceService struct {
	...
	Associations ObjectPartnerServiceAssociationService
...
func NewObjectPartnerServiceService(opts ...option.RequestOption) (r ObjectPartnerServiceService) {
	...
	r.Options = opts
	r.Associations = NewObjectPartnerServiceAssociationService(opts...)
...
func (r *ObjectPartnerServiceService) Update(ctx context.Context, partnerServiceID string, params ObjectPartnerServiceUpdateParams, opts ...option.RequestOption) (res *SimplePublicObject, err error) {
	...
	path := fmt.Sprintf("crm/v3/objects/partner_services/%s", partnerServiceID)
...
// query param.
func (r *ObjectPartnerServiceService) List(ctx context.Context, query ObjectPartnerServiceListParams, opts ...option.RequestOption) (res *pagination.Page[SimplePublicObjectWithAssociations], err error) {
...
// Read a page of partner services. Control what is returned via the `properties`
// query param.
func (r *ObjectPartnerServiceService) ListAutoPaging(ctx context.Context, query ObjectPartnerServiceListParams, opts ...option.RequestOption) *pagination.PageAutoPager[SimplePublicObjectWithAssociations] {
