...
// RequestOption is an option for the requests made by the hubspot API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/hubspot-sdk-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.hubapi.com/")
}
...
// WithDeveloperAPIKey returns a RequestOption that sets the client setting "developer_api_key".
func WithDeveloperAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.DeveloperAPIKey = value
		return r.Apply(WithQuery("hapikey", r.DeveloperAPIKey))
	})
}
