...
```sh
go get -u 'github.com/HubSpot/hubspot-sdk-go@v0.1.0-alpha.6'
```
...
The hubspotsdk library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
`*hubspotsdk.Error`. This contains the `StatusCode`, `*http.Request`, and
