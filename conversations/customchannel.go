...
type PreResolvedContactParam struct {
	...
	// "hs_notes_next_activity_type", "hs_num_associated_open_deals", "hs_persona",
	// "hs_pinned_engagement_id", "hs_pipeline", "hs_predictivecontactscore",
	// "hs_predictivecontactscore_tmp", "hs_predictivecontactscore_v2",
	// "hs_predictivecontactscorebucket", "hs_predictivescoringtier",
	// "hs_predictivescoringtier_tmp", "hs_prospecting_agent_actively_enrolled_count",
	// "hs_prospecting_agent_enrollment_status", "hs_prospecting_agent_last_enrolled",
	// "hs_prospecting_agent_sender", "hs_prospecting_agent_total_enrolled_count",
	// "hs_quarantined_emails", "hs_recent_closed_order_date", "hs_registered_member",
	// "hs_registration_method", "hs_returning_to_office_detected_date", "hs_role",
	...
	// "hs_sourced_contact_origin", "hs_state_code", "hs_sub_role", "hs_testpurge",
	// "hs_testrollback", "hs_tiktok_ad_clicked", "hs_tiktok_click_id",
	...
	// "hs_v2_time_in_current_stage", "hs_whatsapp_phone_number",
	// "hs_why_this_contact", "hubspot_owner_id", "hubspotscore", "industry",
	// "ip_city", "ip_country", "ip_country_code", "ip_latlon", "ip_state",
	// "ip_state_code", "ip_zipcode", "job_function", "jobtitle", "kloutscoregeneral",
	// "lastmodifieddate", "lastname", "lifecyclestage", "linkedinbio",
	// "linkedinconnections", "marital_status", "message", "military_status",
	// "mobilephone", "notes_last_contacted", "notes_last_updated",
	// "notes_next_activity_date", "num_associated_deals", "num_contacted_notes",
	// "num_conversion_events", "num_notes", "num_unique_conversion_events",
	// "numemployees", "owneremail", "ownername", "phone", "photo",
	// "recent_conversion_date", "recent_conversion_event_name", "recent_deal_amount",
	// "recent_deal_close_date", "relationship_status", "salutation", "school",
	// "seniority", "start_date", "state", "surveymonkeyeventlastupdated",
	// "total_revenue", "twitterbio", "twitterhandle", "twitterprofilephoto",
